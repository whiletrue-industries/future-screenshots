import{G as lc,H as cc,I as Mu,J as hc,K as uc,a as Ie,c as ei,u as oc,w as ac}from"./chunk-NEPU7NZP.js";import{$ as ti,$a as Ql,Aa as dr,B as Gl,Ba as Je,C as Wl,Ca as Gi,Da as Ce,Ea as Kl,Fa as ne,G as Xl,Ga as Jl,I as ki,Ia as Wi,Ja as Xi,Jb as ec,Ka as rt,La as gt,Ma as le,Mb as nc,N as Qn,Na as Ae,Qa as Bn,Qb as ic,R as pe,Sb as sc,Ta as ie,Ua as vt,Xa as Cs,Xb as rc,Y as Xt,Ya as As,Z as Yt,Za as Ps,_ as Ze,_a as jl,a as zt,b as mn,bb as Re,ca as Yl,cb as fr,db as Yi,e as bu,f as vi,fa as zi,g as Q,ga as ws,ha as we,i as Un,ia as Vi,ja as Ft,na as ql,oa as Zl,q as Hl,qa as Et,r as kl,sa as Sn,t as zl,ta as $l,ua as an,vb as tc,x as gn,y as Vl,ya as Be,yb as _e,z as ur,zb as ln}from"./chunk-YTDSSQ37.js";var dc=bu(Mu());var Tu=["qrcode"],pr=class s{constructor(t,e){this.el=t;this.platform=e;}url=we("");small=we(!1);codeSize=Ft(0);transform=_e(()=>`scale(${this.scale()})`);scale=_e(()=>{let t=this.mainEl();if(!t)return 1;let e=t.clientHeight/2/this.codeSize();return this.small()?e/5:e;});mainEl=Ft(null);qrCodeEl;ngAfterViewInit(){return Q(this,null,function*(){if(this.platform.browser()){this.mainEl.set(this.el.nativeElement);try{yield dc.default.toCanvas(this.qrCodeEl.nativeElement,this.url(),{scale:16,color:{light:"#FFFDF6",dark:"#4E02B2"}}),this.codeSize.set(this.qrCodeEl.nativeElement.height);}catch(t){console.error("Error generating QR code:",t);}}});}static ɵfac=function(e){return new(e||s)(Sn(Vi),Sn(ei));};static ɵcmp=an({type:s,selectors:[["app-qrcode"]],viewQuery:function(e,n){if(e&1&&Cs(Tu,7),e&2){let i;As(i=Ps())&&(n.qrCodeEl=i.first);}},inputs:{url:[1,"url"],small:[1,"small"]},decls:3,vars:4,consts:[["qrcode",""],[1,"qr-container"],[1,"qrcode"]],template:function(e,n){e&1&&(rt(0,"div",1),le(1,"canvas",2,0),gt()),e&2&&(Ce("small",n.small()),Et(),Gi("transform",n.transform()));},styles:[`
...
void main() {
	...
	#include <colorspace_fragment>
	#include <fog_fragment>
}`,Vt={alphahash_fragment:wd,alphahash_pars_fragment:Cd,alphamap_fragment:Ad,alphamap_pars_fragment:Pd,alphatest_fragment:Rd,alphatest_pars_fragment:Id,aomap_fragment:Od,aomap_pars_fragment:Dd,batching_pars_vertex:Ld,batching_vertex:Fd,begin_vertex:Nd,beginnormal_vertex:Ud,bsdfs:Bd,iridescence_fragment:Hd,bumpmap_pars_fragment:kd,clipping_planes_fragment:zd,clipping_planes_pars_fragment:Vd,clipping_planes_pars_vertex:Gd,clipping_planes_vertex:Wd,color_fragment:Xd,color_pars_fragment:Yd,color_pars_vertex:qd,color_vertex:Zd,common:$d,cube_uv_reflection_fragment:Kd,defaultnormal_vertex:Jd,displacementmap_pars_vertex:jd,displacementmap_vertex:Qd,emissivemap_fragment:tf,emissivemap_pars_fragment:ef,colorspace_fragment:nf,colorspace_pars_fragment:sf,envmap_fragment:rf,envmap_common_pars_fragment:of,envmap_pars_fragment:af,envmap_pars_vertex:lf,envmap_physical_pars_fragment:vf,envmap_vertex:cf,fog_vertex:hf,fog_pars_vertex:uf,fog_fragment:df,fog_pars_fragment:ff,gradientmap_pars_fragment:pf,lightmap_pars_fragment:mf,lights_lambert_fragment:gf,lights_lambert_pars_fragment:_f,lights_pars_begin:yf,lights_toon_fragment:xf,lights_toon_pars_fragment:bf,lights_phong_fragment:Mf,lights_phong_pars_fragment:Sf,lights_physical_fragment:Tf,lights_physical_pars_fragment:Ef,lights_fragment_begin:wf,lights_fragment_maps:Cf,lights_fragment_end:Af,logdepthbuf_fragment:Pf,logdepthbuf_pars_fragment:Rf,logdepthbuf_pars_vertex:If,logdepthbuf_vertex:Of,map_fragment:Df,map_pars_fragment:Lf,map_particle_fragment:Ff,map_particle_pars_fragment:Nf,metalnessmap_fragment:Uf,metalnessmap_pars_fragment:Bf,morphinstance_vertex:Hf,morphcolor_vertex:kf,morphnormal_vertex:zf,morphtarget_pars_vertex:Vf,morphtarget_vertex:Gf,normal_fragment_begin:Wf,normal_fragment_maps:Xf,normal_pars_fragment:Yf,normal_pars_vertex:qf,normal_vertex:Zf,normalmap_pars_fragment:$f,clearcoat_normal_fragment_begin:Kf,clearcoat_normal_fragment_maps:Jf,clearcoat_pars_fragment:jf,iridescence_pars_fragment:Qf,opaque_fragment:tp,packing:ep,premultiplied_alpha_fragment:np,project_vertex:ip,dithering_fragment:sp,dithering_pars_fragment:rp,roughnessmap_fragment:op,roughnessmap_pars_fragment:ap,shadowmap_pars_fragment:lp,shadowmap_pars_vertex:cp,shadowmap_vertex:hp,shadowmask_pars_fragment:up,skinbase_vertex:dp,skinning_pars_vertex:fp,skinning_vertex:pp,skinnormal_vertex:mp,specularmap_fragment:gp,specularmap_pars_fragment:_p,tonemapping_fragment:yp,tonemapping_pars_fragment:vp,transmission_fragment:xp,transmission_pars_fragment:bp,uv_pars_fragment:Mp,uv_pars_vertex:Sp,uv_vertex:Tp,worldpos_vertex:Ep,background_vert:wp,background_frag:Cp,backgroundCube_vert:Ap,backgroundCube_frag:Pp,cube_vert:Rp,cube_frag:Ip,depth_vert:Op,depth_frag:Dp,distanceRGBA_vert:Lp,distanceRGBA_frag:Fp,equirect_vert:Np,equirect_frag:Up,linedashed_vert:Bp,linedashed_frag:Hp,meshbasic_vert:kp,meshbasic_frag:zp,meshlambert_vert:Vp,meshlambert_frag:Gp,meshmatcap_vert:Wp,meshmatcap_frag:Xp,meshnormal_vert:Yp,meshnormal_frag:qp,meshphong_vert:Zp,meshphong_frag:$p,meshphysical_vert:Kp,meshphysical_frag:Jp,meshtoon_vert:jp,meshtoon_frag:Qp,points_vert:tm,points_frag:em,shadow_vert:nm,shadow_frag:im,sprite_vert:sm,sprite_frag:rm},ot={common:{diffuse:{value:new Qt(16777215)},opacity:{value:1},map:{value:null},mapTransform:{value:new Ht()},alphaMap:{value:null},alphaMapTransform:{value:new Ht()},alphaTest:{value:0}},specularmap:{specularMap:{value:null},specularMapTransform:{value:new Ht()}},envmap:{envMap:{value:null},envMapRotation:{value:new Ht()},flipEnvMap:{value:-1},reflectivity:{value:1},ior:{value:1.5},refractionRatio:{value:.98}},aomap:{aoMap:{value:null},aoMapIntensity:{value:1},aoMapTransform:{value:new Ht()}},lightmap:{lightMap:{value:null},lightMapIntensity:{value:1},lightMapTransform:{value:new Ht()}},bumpmap:{bumpMap:{value:null},bumpMapTransform:{value:new Ht()},bumpScale:{value:1}},normalmap:{normalMap:{value:null},normalMapTransform:{value:new Ht()},normalScale:{value:new $t(1,1)}},displacementmap:{displacementMap:{value:null},displacementMapTransform:{value:new Ht()},displacementScale:{value:1},displacementBias:{value:0}},emissivemap:{emissiveMap:{value:null},emissiveMapTransform:{value:new Ht()}},metalnessmap:{metalnessMap:{value:null},metalnessMapTransform:{value:new Ht()}},roughnessmap:{roughnessMap:{value:null},roughnessMapTransform:{value:new Ht()}},gradientmap:{gradientMap:{value:null}},fog:{fogDensity:{value:25e-5},fogNear:{value:1},fogFar:{value:2e3},fogColor:{value:new Qt(16777215)}},lights:{ambientLightColor:{value:[]},lightProbe:{value:[]},directionalLights:{value:[],properties:{direction:{},color:{}}},directionalLightShadows:{value:[],properties:{shadowIntensity:1,shadowBias:{},shadowNormalBias:{},shadowRadius:{},shadowMapSize:{}}},directionalShadowMap:{value:[]},directionalShadowMatrix:{value:[]},spotLights:{value:[],properties:{color:{},position:{},direction:{},distance:{},coneCos:{},penumbraCos:{},decay:{}}},spotLightShadows:{value:[],properties:{shadowIntensity:1,shadowBias:{},shadowNormalBias:{},shadowRadius:{},shadowMapSize:{}}},spotLightMap:{value:[]},spotShadowMap:{value:[]},spotLightMatrix:{value:[]},pointLights:{value:[],properties:{color:{},position:{},decay:{},distance:{}}},pointLightShadows:{value:[],properties:{shadowIntensity:1,shadowBias:{},shadowNormalBias:{},shadowRadius:{},shadowMapSize:{},shadowCameraNear:{},shadowCameraFar:{}}},pointShadowMap:{value:[]},pointShadowMatrix:{value:[]},hemisphereLights:{value:[],properties:{direction:{},skyColor:{},groundColor:{}}},rectAreaLights:{value:[],properties:{color:{},position:{},width:{},height:{}}},ltc_1:{value:null},ltc_2:{value:null}},points:{diffuse:{value:new Qt(16777215)},opacity:{value:1},size:{value:1},scale:{value:1},map:{value:null},alphaMap:{value:null},alphaMapTransform:{value:new Ht()},alphaTest:{value:0},uvTransform:{value:new Ht()}},sprite:{diffuse:{value:new Qt(16777215)},opacity:{value:1},center:{value:new $t(.5,.5)},rotation:{value:0},map:{value:null},mapTransform:{value:new Ht()},alphaMap:{value:null},alphaMapTransform:{value:new Ht()},alphaTest:{value:0}}},Fn={basic:{uniforms:Ve([ot.common,ot.specularmap,ot.envmap,ot.aomap,ot.lightmap,ot.fog]),vertexShader:Vt.meshbasic_vert,fragmentShader:Vt.meshbasic_frag},lambert:{uniforms:Ve([ot.common,ot.specularmap,ot.envmap,ot.aomap,ot.lightmap,ot.emissivemap,ot.bumpmap,ot.normalmap,ot.displacementmap,ot.fog,ot.lights,{emissive:{value:new Qt(0)}}]),vertexShader:Vt.meshlambert_vert,fragmentShader:Vt.meshlambert_frag},phong:{uniforms:Ve([ot.common,ot.specularmap,ot.envmap,ot.aomap,ot.lightmap,ot.emissivemap,ot.bumpmap,ot.normalmap,ot.displacementmap,ot.fog,ot.lights,{emissive:{value:new Qt(0)},specular:{value:new Qt(1118481)},shininess:{value:30}}]),vertexShader:Vt.meshphong_vert,fragmentShader:Vt.meshphong_frag},standard:{uniforms:Ve([ot.common,ot.envmap,ot.aomap,ot.lightmap,ot.emissivemap,ot.bumpmap,ot.normalmap,ot.displacementmap,ot.roughnessmap,ot.metalnessmap,ot.fog,ot.lights,{emissive:{value:new Qt(0)},roughness:{value:1},metalness:{value:0},envMapIntensity:{value:1}}]),vertexShader:Vt.meshphysical_vert,fragmentShader:Vt.meshphysical_frag},toon:{uniforms:Ve([ot.common,ot.aomap,ot.lightmap,ot.emissivemap,ot.bumpmap,ot.normalmap,ot.displacementmap,ot.gradientmap,ot.fog,ot.lights,{emissive:{value:new Qt(0)}}]),vertexShader:Vt.meshtoon_vert,fragmentShader:Vt.meshtoon_frag},matcap:{uniforms:Ve([ot.common,ot.bumpmap,ot.normalmap,ot.displacementmap,ot.fog,{matcap:{value:null}}]),vertexShader:Vt.meshmatcap_vert,fragmentShader:Vt.meshmatcap_frag},points:{uniforms:Ve([ot.points,ot.fog]),vertexShader:Vt.points_vert,fragmentShader:Vt.points_frag},dashed:{uniforms:Ve([ot.common,ot.fog,{scale:{value:1},dashSize:{value:1},totalSize:{value:2}}]),vertexShader:Vt.linedashed_vert,fragmentShader:Vt.linedashed_frag},depth:{uniforms:Ve([ot.common,ot.displacementmap]),vertexShader:Vt.depth_vert,fragmentShader:Vt.depth_frag},normal:{uniforms:Ve([ot.common,ot.bumpmap,ot.normalmap,ot.displacementmap,{opacity:{value:1}}]),vertexShader:Vt.meshnormal_vert,fragmentShader:Vt.meshnormal_frag},sprite:{uniforms:Ve([ot.sprite,ot.fog]),vertexShader:Vt.sprite_vert,fragmentShader:Vt.sprite_frag},background:{uniforms:{uvTransform:{value:new Ht()},t2D:{value:null},backgroundIntensity:{value:1}},vertexShader:Vt.background_vert,fragmentShader:Vt.background_frag},backgroundCube:{uniforms:{envMap:{value:null},flipEnvMap:{value:-1},backgroundBlurriness:{value:0},backgroundIntensity:{value:1},backgroundRotation:{value:new Ht()}},vertexShader:Vt.backgroundCube_vert,fragmentShader:Vt.backgroundCube_frag},cube:{uniforms:{tCube:{value:null},tFlip:{value:-1},opacity:{value:1}},vertexShader:Vt.cube_vert,fragmentShader:Vt.cube_frag},equirect:{uniforms:{tEquirect:{value:null}},vertexShader:Vt.equirect_vert,fragmentShader:Vt.equirect_frag},distanceRGBA:{uniforms:Ve([ot.common,ot.displacementmap,{referencePosition:{value:new N()},nearDistance:{value:1},farDistance:{value:1e3}}]),vertexShader:Vt.distanceRGBA_vert,fragmentShader:Vt.distanceRGBA_frag},shadow:{uniforms:Ve([ot.lights,ot.fog,{color:{value:new Qt(0)},opacity:{value:1}}]),vertexShader:Vt.shadow_vert,fragmentShader:Vt.shadow_frag}};Fn.physical={uniforms:Ve([Fn.standard.uniforms,{clearcoat:{value:0},clearcoatMap:{value:null},clearcoatMapTransform:{value:new Ht()},clearcoatNormalMap:{value:null},clearcoatNormalMapTransform:{value:new Ht()},clearcoatNormalScale:{value:new $t(1,1)},clearcoatRoughness:{value:0},clearcoatRoughnessMap:{value:null},clearcoatRoughnessMapTransform:{value:new Ht()},dispersion:{value:0},iridescence:{value:0},iridescenceMap:{value:null},iridescenceMapTransform:{value:new Ht()},iridescenceIOR:{value:1.3},iridescenceThicknessMinimum:{value:100},iridescenceThicknessMaximum:{value:400},iridescenceThicknessMap:{value:null},iridescenceThicknessMapTransform:{value:new Ht()},sheen:{value:0},sheenColor:{value:new Qt(0)},sheenColorMap:{value:null},sheenColorMapTransform:{value:new Ht()},sheenRoughness:{value:1},sheenRoughnessMap:{value:null},sheenRoughnessMapTransform:{value:new Ht()},transmission:{value:0},transmissionMap:{value:null},transmissionMapTransform:{value:new Ht()},transmissionSamplerSize:{value:new $t()},transmissionSamplerMap:{value:null},thickness:{value:0},thicknessMap:{value:null},thicknessMapTransform:{value:new Ht()},attenuationDistance:{value:0},attenuationColor:{value:new Qt(0)},specularColor:{value:new Qt(1,1,1)},specularColorMap:{value:null},specularColorMapTransform:{value:new Ht()},specularIntensity:{value:1},specularIntensityMap:{value:null},specularIntensityMapTransform:{value:new Ht()},anisotropyVector:{value:new $t()},anisotropyMap:{value:null},anisotropyMapTransform:{value:new Ht()}}]),vertexShader:Vt.meshphysical_vert,fragmentShader:Vt.meshphysical_frag};var ia={r:0,b:0,g:0},Fi=new Pi(),om=new Me();function am(s,t,e,n,i,r,o){let a=new Qt(0),c=r===!0?0:1,l,h,u=null,d=0,f=null;function g(S){let x=S.isScene===!0?S.background:null;return x&&x.isTexture&&(x=(S.backgroundBlurriness>0?e:t).get(x)),x;}function _(S){let x=!1,C=g(S);C===null?p(a,c):C&&C.isColor&&(p(C,1),x=!0);let A=s.xr.getEnvironmentBlendMode();A==="additive"?n.buffers.color.setClear(0,0,0,1,o):A==="alpha-blend"&&n.buffers.color.setClear(0,0,0,0,o),(s.autoClear||x)&&(n.buffers.depth.setTest(!0),n.buffers.depth.setMask(!0),n.buffers.color.setMask(!0),s.clear(s.autoClearColor,s.autoClearDepth,s.autoClearStencil));}function m(S,x){let C=g(x);C&&(C.isCubeTexture||C.mapping===tr)?(h===void 0&&(h=new Ue(new ps(1,1,1),new bn({name:"BackgroundCubeMaterial",uniforms:Li(Fn.backgroundCube.uniforms),vertexShader:Fn.backgroundCube.vertexShader,fragmentShader:Fn.backgroundCube.fragmentShader,side:Ye,depthTest:!1,depthWrite:!1,fog:!1,allowOverride:!1})),h.geometry.deleteAttribute("normal"),h.geometry.deleteAttribute("uv"),h.onBeforeRender=function(A,R,O){this.matrixWorld.copyPosition(O.matrixWorld);},Object.defineProperty(h.material,"envMap",{get:function(){return this.uniforms.envMap.value;}}),i.update(h)),Fi.copy(x.backgroundRotation),Fi.x*=-1,Fi.y*=-1,Fi.z*=-1,C.isCubeTexture&&C.isRenderTargetTexture===!1&&(Fi.y*=-1,Fi.z*=-1),h.material.uniforms.envMap.value=C,h.material.uniforms.flipEnvMap.value=C.isCubeTexture&&C.isRenderTargetTexture===!1?-1:1,h.material.uniforms.backgroundBlurriness.value=x.backgroundBlurriness,h.material.uniforms.backgroundIntensity.value=x.backgroundIntensity,h.material.uniforms.backgroundRotation.value.setFromMatrix4(om.makeRotationFromEuler(Fi)),h.material.toneMapped=Jt.getTransfer(C.colorSpace)!==oe,(u!==C||d!==C.version||f!==s.toneMapping)&&(h.material.needsUpdate=!0,u=C,d=C.version,f=s.toneMapping),h.layers.enableAll(),S.unshift(h,h.geometry,h.material,0,0,null)):C&&C.isTexture&&(l===void 0&&(l=new Ue(new Pn(2,2),new bn({name:"BackgroundMaterial",uniforms:Li(Fn.background.uniforms),vertexShader:Fn.background.vertexShader,fragmentShader:Fn.background.fragmentShader,side:qn,depthTest:!1,depthWrite:!1,fog:!1,allowOverride:!1})),l.geometry.deleteAttribute("normal"),Object.defineProperty(l.material,"map",{get:function(){return this.uniforms.t2D.value;}}),i.update(l)),l.material.uniforms.t2D.value=C,l.material.uniforms.backgroundIntensity.value=x.backgroundIntensity,l.material.toneMapped=Jt.getTransfer(C.colorSpace)!==oe,C.matrixAutoUpdate===!0&&C.updateMatrix(),l.material.uniforms.uvTransform.value.copy(C.matrix),(u!==C||d!==C.version||f!==s.toneMapping)&&(l.material.needsUpdate=!0,u=C,d=C.version,f=s.toneMapping),l.layers.enableAll(),S.unshift(l,l.geometry,l.material,0,0,null));}function p(S,x){S.getRGB(ia,fl(s)),n.buffers.color.setClear(ia.r,ia.g,ia.b,x,o);}function T(){h!==void 0&&(h.geometry.dispose(),h.material.dispose(),h=void 0),l!==void 0&&(l.geometry.dispose(),l.material.dispose(),l=void 0);}return{getClearColor:function(){return a;},setClearColor:function(S,x=1){a.set(S),c=x,p(a,c);},getClearAlpha:function(){return c;},setClearAlpha:function(S){c=S,p(a,c);},render:_,addToRenderList:m,dispose:T};}function lm(s,t){let e=s.getParameter(s.MAX_VERTEX_ATTRIBS),n={},i=d(null),r=i,o=!1;function a(b,w,z,H,X){let Z=!1,Y=u(H,z,w);r!==Y&&(r=Y,l(r.object)),Z=f(b,H,z,X),Z&&g(b,H,z,X),X!==null&&t.update(X,s.ELEMENT_ARRAY_BUFFER),(Z||o)&&(o=!1,x(b,w,z,H),X!==null&&s.bindBuffer(s.ELEMENT_ARRAY_BUFFER,t.get(X).buffer));}function c(){return s.createVertexArray();}function l(b){return s.bindVertexArray(b);}function h(b){return s.deleteVertexArray(b);}function u(b,w,z){let H=z.wireframe===!0,X=n[b.id];X===void 0&&(X={},n[b.id]=X);let Z=X[w.id];Z===void 0&&(Z={},X[w.id]=Z);let Y=Z[H];return Y===void 0&&(Y=d(c()),Z[H]=Y),Y;}function d(b){let w=[],z=[],H=[];for(let X=0;X<e;X++)w[X]=0,z[X]=0,H[X]=0;return{geometry:null,program:null,wireframe:!1,newAttributes:w,enabledAttributes:z,attributeDivisors:H,object:b,attributes:{},index:null};}function f(b,w,z,H){let X=r.attributes,Z=w.attributes,Y=0,$=z.getAttributes();for(let k in $)if($[k].location>=0){let dt=X[k],wt=Z[k];if(wt===void 0&&(k==="instanceMatrix"&&b.instanceMatrix&&(wt=b.instanceMatrix),k==="instanceColor"&&b.instanceColor&&(wt=b.instanceColor)),dt===void 0||dt.attribute!==wt||wt&&dt.data!==wt.data)return!0;Y++;}return r.attributesNum!==Y||r.index!==H;}function g(b,w,z,H){let X={},Z=w.attributes,Y=0,$=z.getAttributes();for(let k in $)if($[k].location>=0){let dt=Z[k];dt===void 0&&(k==="instanceMatrix"&&b.instanceMatrix&&(dt=b.instanceMatrix),k==="instanceColor"&&b.instanceColor&&(dt=b.instanceColor));let wt={};wt.attribute=dt,dt&&dt.data&&(wt.data=dt.data),X[k]=wt,Y++;}r.attributes=X,r.attributesNum=Y,r.index=H;}function _(){let b=r.newAttributes;for(let w=0,z=b.length;w<z;w++)b[w]=0;}function m(b){p(b,0);}function p(b,w){let z=r.newAttributes,H=r.enabledAttributes,X=r.attributeDivisors;z[b]=1,H[b]===0&&(s.enableVertexAttribArray(b),H[b]=1),X[b]!==w&&(s.vertexAttribDivisor(b,w),X[b]=w);}function T(){let b=r.newAttributes,w=r.enabledAttributes;for(let z=0,H=w.length;z<H;z++)w[z]!==b[z]&&(s.disableVertexAttribArray(z),w[z]=0);}function S(b,w,z,H,X,Z,Y){Y===!0?s.vertexAttribIPointer(b,w,z,X,Z):s.vertexAttribPointer(b,w,z,H,X,Z);}function x(b,w,z,H){_();let X=H.attributes,Z=z.getAttributes(),Y=w.defaultAttributeValues;for(let $ in Z){let k=Z[$];if(k.location>=0){let at=X[$];if(at===void 0&&($==="instanceMatrix"&&b.instanceMatrix&&(at=b.instanceMatrix),$==="instanceColor"&&b.instanceColor&&(at=b.instanceColor)),at!==void 0){let dt=at.normalized,wt=at.itemSize,Gt=t.get(at);if(Gt===void 0)continue;let me=Gt.buffer,ce=Gt.type,W=Gt.bytesPerElement,lt=ce===s.INT||ce===s.UNSIGNED_INT||at.gpuType===Eo;if(at.isInterleavedBufferAttribute){let it=at.data,Rt=it.stride,It=at.offset;if(it.isInstancedInterleavedBuffer){for(let Ut=0;Ut<k.locationSize;Ut++)p(k.location+Ut,it.meshPerAttribute);b.isInstancedMesh!==!0&&H._maxInstanceCount===void 0&&(H._maxInstanceCount=it.meshPerAttribute*it.count);}else for(let Ut=0;Ut<k.locationSize;Ut++)m(k.location+Ut);s.bindBuffer(s.ARRAY_BUFFER,me);for(let Ut=0;Ut<k.locationSize;Ut++)S(k.location+Ut,wt/k.locationSize,ce,dt,Rt*W,(It+wt/k.locationSize*Ut)*W,lt);}else{if(at.isInstancedBufferAttribute){for(let it=0;it<k.locationSize;it++)p(k.location+it,at.meshPerAttribute);b.isInstancedMesh!==!0&&H._maxInstanceCount===void 0&&(H._maxInstanceCount=at.meshPerAttribute*at.count);}else for(let it=0;it<k.locationSize;it++)m(k.location+it);s.bindBuffer(s.ARRAY_BUFFER,me);for(let it=0;it<k.locationSize;it++)S(k.location+it,wt/k.locationSize,ce,dt,wt*W,wt/k.locationSize*it*W,lt);}}else if(Y!==void 0){let dt=Y[$];if(dt!==void 0)switch(dt.length){case 2:s.vertexAttrib2fv(k.location,dt);break;case 3:s.vertexAttrib3fv(k.location,dt);break;case 4:s.vertexAttrib4fv(k.location,dt);break;default:s.vertexAttrib1fv(k.location,dt);}}}}T();}function C(){O();for(let b in n){let w=n[b];for(let z in w){let H=w[z];for(let X in H)h(H[X].object),delete H[X];delete w[z];}delete n[b];}}function A(b){if(n[b.id]===void 0)return;let w=n[b.id];for(let z in w){let H=w[z];for(let X in H)h(H[X].object),delete H[X];delete w[z];}delete n[b.id];}function R(b){for(let w in n){let z=n[w];if(z[b.id]===void 0)continue;let H=z[b.id];for(let X in H)h(H[X].object),delete H[X];delete z[b.id];}}function O(){M(),o=!0,r!==i&&(r=i,l(r.object));}function M(){i.geometry=null,i.program=null,i.wireframe=!1;}return{setup:a,reset:O,resetDefaultState:M,dispose:C,releaseStatesOfGeometry:A,releaseStatesOfProgram:R,initAttributes:_,enableAttribute:m,disableUnusedAttributes:T};}function cm(s,t,e){let n;function i(l){n=l;}function r(l,h){s.drawArrays(n,l,h),e.update(h,n,1);}function o(l,h,u){u!==0&&(s.drawArraysInstanced(n,l,h,u),e.update(h,n,u));}function a(l,h,u){if(u===0)return;t.get("WEBGL_multi_draw").multiDrawArraysWEBGL(n,l,0,h,0,u);let f=0;for(let g=0;g<u;g++)f+=h[g];e.update(f,n,1);}function c(l,h,u,d){if(u===0)return;let f=t.get("WEBGL_multi_draw");if(f===null)for(let g=0;g<l.length;g++)o(l[g],h[g],d[g]);else{f.multiDrawArraysInstancedWEBGL(n,l,0,h,0,d,0,u);let g=0;for(let _=0;_<u;_++)g+=h[_]*d[_];e.update(g,n,1);}}this.setMode=i,this.render=r,this.renderInstances=o,this.renderMultiDraw=a,this.renderMultiDrawInstances=c;}function hm(s,t,e,n){let i;function r(){if(i!==void 0)return i;if(t.has("EXT_texture_filter_anisotropic")===!0){let R=t.get("EXT_texture_filter_anisotropic");i=s.getParameter(R.MAX_TEXTURE_MAX_ANISOTROPY_EXT);}else i=0;return i;}function o(R){return!(R!==fn&&n.convert(R)!==s.getParameter(s.IMPLEMENTATION_COLOR_READ_FORMAT));}function a(R){let O=R===_s&&(t.has("EXT_color_buffer_half_float")||t.has("EXT_color_buffer_float"));return!(R!==Dn&&n.convert(R)!==s.getParameter(s.IMPLEMENTATION_COLOR_READ_TYPE)&&R!==Ln&&!O);}function c(R){if(R==="highp"){if(s.getShaderPrecisionFormat(s.VERTEX_SHADER,s.HIGH_FLOAT).precision>0&&s.getShaderPrecisionFormat(s.FRAGMENT_SHADER,s.HIGH_FLOAT).precision>0)return"highp";R="mediump";}return R==="mediump"&&s.getShaderPrecisionFormat(s.VERTEX_SHADER,s.MEDIUM_FLOAT).precision>0&&s.getShaderPrecisionFormat(s.FRAGMENT_SHADER,s.MEDIUM_FLOAT).precision>0?"mediump":"lowp";}let l=e.precision!==void 0?e.precision:"highp",h=c(l);h!==l&&(console.warn("THREE.WebGLRenderer:",l,"not supported, using",h,"instead."),l=h);let u=e.logarithmicDepthBuffer===!0,d=e.reversedDepthBuffer===!0&&t.has("EXT_clip_control"),f=s.getParameter(s.MAX_TEXTURE_IMAGE_UNITS),g=s.getParameter(s.MAX_VERTEX_TEXTURE_IMAGE_UNITS),_=s.getParameter(s.MAX_TEXTURE_SIZE),m=s.getParameter(s.MAX_CUBE_MAP_TEXTURE_SIZE),p=s.getParameter(s.MAX_VERTEX_ATTRIBS),T=s.getParameter(s.MAX_VERTEX_UNIFORM_VECTORS),S=s.getParameter(s.MAX_VARYING_VECTORS),x=s.getParameter(s.MAX_FRAGMENT_UNIFORM_VECTORS),C=g>0,A=s.getParameter(s.MAX_SAMPLES);return{isWebGL2:!0,getMaxAnisotropy:r,getMaxPrecision:c,textureFormatReadable:o,textureTypeReadable:a,precision:l,logarithmicDepthBuffer:u,reversedDepthBuffer:d,maxTextures:f,maxVertexTextures:g,maxTextureSize:_,maxCubemapSize:m,maxAttributes:p,maxVertexUniforms:T,maxVaryings:S,maxFragmentUniforms:x,vertexTextures:C,maxSamples:A};}function um(s){let t=this,e=null,n=0,i=!1,r=!1,o=new hn(),a=new Ht(),c={value:null,needsUpdate:!1};this.uniform=c,this.numPlanes=0,this.numIntersection=0,this.init=function(u,d){let f=u.length!==0||d||n!==0||i;return i=d,n=u.length,f;},this.beginShadows=function(){r=!0,h(null);},this.endShadows=function(){r=!1;},this.setGlobalState=function(u,d){e=h(u,d,0);},this.setState=function(u,d,f){let g=u.clippingPlanes,_=u.clipIntersection,m=u.clipShadows,p=s.get(u);if(!i||g===null||g.length===0||r&&!m)r?h(null):l();else{let T=r?0:n,S=T*4,x=p.clippingState||null;c.value=x,x=h(g,d,S,f);for(let C=0;C!==S;++C)x[C]=e[C];p.clippingState=x,this.numIntersection=_?this.numPlanes:0,this.numPlanes+=T;}};function l(){c.value!==e&&(c.value=e,c.needsUpdate=n>0),t.numPlanes=n,t.numIntersection=0;}function h(u,d,f,g){let _=u!==null?u.length:0,m=null;if(_!==0){if(m=c.value,g!==!0||m===null){let p=f+_*4,T=d.matrixWorldInverse;a.getNormalMatrix(T),(m===null||m.length<p)&&(m=new Float32Array(p));for(let S=0,x=f;S!==_;++S,x+=4)o.copy(u[S]).applyMatrix4(T,a),o.normal.toArray(m,x),m[x+3]=o.constant;}c.value=m,c.needsUpdate=!0;}return t.numPlanes=_,t.numIntersection=0,m;}}function dm(s){let t=new WeakMap();function e(o,a){return a===Mo?o.mapping=Oi:a===So&&(o.mapping=Di),o;}function n(o){if(o&&o.isTexture){let a=o.mapping;if(a===Mo||a===So)if(t.has(o)){let c=t.get(o).texture;return e(c,o.mapping);}else{let c=o.image;if(c&&c.height>0){let l=new jr(c.height);return l.fromEquirectangularTexture(s,o),t.set(o,l),o.addEventListener("dispose",i),e(l.texture,o.mapping);}else return null;}}return o;}function i(o){let a=o.target;a.removeEventListener("dispose",i);let c=t.get(a);c!==void 0&&(t.delete(a),c.dispose());}function r(){t=new WeakMap();}return{get:n,dispose:r};}var Ms=4,Hh=[.125,.215,.35,.446,.526,.582],Bi=20,yl=new uo(),kh=new Qt(),vl=null,xl=0,bl=0,Ml=!1,Ui=(1+Math.sqrt(5))/2,bs=1/Ui,zh=[new N(-Ui,bs,0),new N(Ui,bs,0),new N(-bs,0,Ui),new N(bs,0,Ui),new N(0,Ui,-bs),new N(0,Ui,bs),new N(-1,1,-1),new N(1,1,-1),new N(-1,1,1),new N(1,1,1)],fm=new N(),oa=class{constructor(t){this._renderer=t,this._pingPongRenderTarget=null,this._lodMax=0,this._cubeSize=0,this._lodPlanes=[],this._sizeLods=[],this._sigmas=[],this._blurMaterial=null,this._cubemapMaterial=null,this._equirectMaterial=null,this._compileMaterial(this._blurMaterial);}fromScene(t,e=0,n=.1,i=100,r={}){let{size:o=256,position:a=fm}=r;vl=this._renderer.getRenderTarget(),xl=this._renderer.getActiveCubeFace(),bl=this._renderer.getActiveMipmapLevel(),Ml=this._renderer.xr.enabled,this._renderer.xr.enabled=!1,this._setSize(o);let c=this._allocateTargets();return c.depthBuffer=!0,this._sceneToCubeUV(t,n,i,c,a),e>0&&this._blur(c,0,0,e),this._applyPMREM(c),this._cleanup(c),c;}fromEquirectangular(t,e=null){return this._fromTexture(t,e);}fromCubemap(t,e=null){return this._fromTexture(t,e);}compileCubemapShader(){this._cubemapMaterial===null&&(this._cubemapMaterial=Wh(),this._compileMaterial(this._cubemapMaterial));}compileEquirectangularShader(){this._equirectMaterial===null&&(this._equirectMaterial=Gh(),this._compileMaterial(this._equirectMaterial));}dispose(){this._dispose(),this._cubemapMaterial!==null&&this._cubemapMaterial.dispose(),this._equirectMaterial!==null&&this._equirectMaterial.dispose();}_setSize(t){this._lodMax=Math.floor(Math.log2(t)),this._cubeSize=Math.pow(2,this._lodMax);}_dispose(){this._blurMaterial!==null&&this._blurMaterial.dispose(),this._pingPongRenderTarget!==null&&this._pingPongRenderTarget.dispose();for(let t=0;t<this._lodPlanes.length;t++)this._lodPlanes[t].dispose();}_cleanup(t){this._renderer.setRenderTarget(vl,xl,bl),this._renderer.xr.enabled=Ml,t.scissorTest=!1,sa(t,0,0,t.width,t.height);}_fromTexture(t,e){t.mapping===Oi||t.mapping===Di?this._setSize(t.image.length===0?16:t.image[0].width||t.image[0].image.width):this._setSize(t.image.width/4),vl=this._renderer.getRenderTarget(),xl=this._renderer.getActiveCubeFace(),bl=this._renderer.getActiveMipmapLevel(),Ml=this._renderer.xr.enabled,this._renderer.xr.enabled=!1;let n=e||this._allocateTargets();return this._textureToCubeUV(t,n),this._applyPMREM(n),this._cleanup(n),n;}_allocateTargets(){let t=3*Math.max(this._cubeSize,112),e=4*this._cubeSize,n={magFilter:Xe,minFilter:Xe,generateMipmaps:!1,type:_s,format:fn,colorSpace:Ci,depthBuffer:!1},i=Vh(t,e,n);if(this._pingPongRenderTarget===null||this._pingPongRenderTarget.width!==t||this._pingPongRenderTarget.height!==e){this._pingPongRenderTarget!==null&&this._dispose(),this._pingPongRenderTarget=Vh(t,e,n);let{_lodMax:r}=this;({sizeLods:this._sizeLods,lodPlanes:this._lodPlanes,sigmas:this._sigmas}=pm(r)),this._blurMaterial=mm(r,t,e);}return i;}_compileMaterial(t){let e=new Ue(this._lodPlanes[0],t);this._renderer.compile(e,yl);}_sceneToCubeUV(t,e,n,i,r){let c=new ze(90,1,e,n),l=[1,-1,1,1,1,1],h=[1,1,1,-1,-1,-1],u=this._renderer,d=u.autoClear,f=u.toneMapping;u.getClearColor(kh),u.toneMapping=Jn,u.autoClear=!1,u.state.buffers.depth.getReversed()&&(u.setRenderTarget(i),u.clearDepth(),u.setRenderTarget(null));let _=new dn({name:"PMREM.Background",side:Ye,depthWrite:!1,depthTest:!1}),m=new Ue(new ps(),_),p=!1,T=t.background;T?T.isColor&&(_.color.copy(T),t.background=null,p=!0):(_.color.copy(kh),p=!0);for(let S=0;S<6;S++){let x=S%3;x===0?(c.up.set(0,l[S],0),c.position.set(r.x,r.y,r.z),c.lookAt(r.x+h[S],r.y,r.z)):x===1?(c.up.set(0,0,l[S]),c.position.set(r.x,r.y,r.z),c.lookAt(r.x,r.y+h[S],r.z)):(c.up.set(0,l[S],0),c.position.set(r.x,r.y,r.z),c.lookAt(r.x,r.y,r.z+h[S]));let C=this._cubeSize;sa(i,x*C,S>2?C:0,C,C),u.setRenderTarget(i),p&&u.render(m,c),u.render(t,c);}m.geometry.dispose(),m.material.dispose(),u.toneMapping=f,u.autoClear=d,t.background=T;}_textureToCubeUV(t,e){let n=this._renderer,i=t.mapping===Oi||t.mapping===Di;i?(this._cubemapMaterial===null&&(this._cubemapMaterial=Wh()),this._cubemapMaterial.uniforms.flipEnvMap.value=t.isRenderTargetTexture===!1?-1:1):this._equirectMaterial===null&&(this._equirectMaterial=Gh());let r=i?this._cubemapMaterial:this._equirectMaterial,o=new Ue(this._lodPlanes[0],r),a=r.uniforms;a.envMap.value=t;let c=this._cubeSize;sa(e,0,0,3*c,2*c),n.setRenderTarget(e),n.render(o,yl);}_applyPMREM(t){let e=this._renderer,n=e.autoClear;e.autoClear=!1;let i=this._lodPlanes.length;for(let r=1;r<i;r++){let o=Math.sqrt(this._sigmas[r]*this._sigmas[r]-this._sigmas[r-1]*this._sigmas[r-1]),a=zh[(i-r-1)%zh.length];this._blur(t,r-1,r,o,a);}e.autoClear=n;}_blur(t,e,n,i,r){let o=this._pingPongRenderTarget;this._halfBlur(t,o,e,n,i,"latitudinal",r),this._halfBlur(o,t,n,n,i,"longitudinal",r);}_halfBlur(t,e,n,i,r,o,a){let c=this._renderer,l=this._blurMaterial;o!=="latitudinal"&&o!=="longitudinal"&&console.error("blur direction must be either latitudinal or longitudinal!");let h=3,u=new Ue(this._lodPlanes[i],l),d=l.uniforms,f=this._sizeLods[n]-1,g=isFinite(r)?Math.PI/(2*f):2*Math.PI/(2*Bi-1),_=r/g,m=isFinite(r)?1+Math.floor(h*_):Bi;m>Bi&&console.warn(`sigmaRadians, ${r}, is too large and will clip, as it requested ${m} samples when the maximum is set to ${Bi}`);let p=[],T=0;for(let R=0;R<Bi;++R){let O=R/_,M=Math.exp(-O*O/2);p.push(M),R===0?T+=M:R<m&&(T+=2*M);}for(let R=0;R<p.length;R++)p[R]=p[R]/T;d.envMap.value=t.texture,d.samples.value=m,d.weights.value=p,d.latitudinal.value=o==="latitudinal",a&&(d.poleAxis.value=a);let{_lodMax:S}=this;d.dTheta.value=g,d.mipInt.value=S-n;let x=this._sizeLods[i],C=3*x*(i>S-Ms?i-S+Ms:0),A=4*(this._cubeSize-x);sa(e,C,A,3*x,2*x),c.setRenderTarget(e),c.render(u,yl);}};function pm(s){let t=[],e=[],n=[],i=s,r=s-Ms+1+Hh.length;for(let o=0;o<r;o++){let a=Math.pow(2,i);e.push(a);let c=1/a;o>s-Ms?c=Hh[o-s+Ms-1]:o===0&&(c=0),n.push(c);let l=1/(a-2),h=-l,u=1+l,d=[h,h,u,h,u,u,h,h,u,u,h,u],f=6,g=6,_=3,m=2,p=1,T=new Float32Array(_*g*f),S=new Float32Array(m*g*f),x=new Float32Array(p*g*f);for(let A=0;A<f;A++){let R=A%3*2/3-1,O=A>2?0:-1,M=[R,O,0,R+2/3,O,0,R+2/3,O+1,0,R,O,0,R+2/3,O+1,0,R,O+1,0];T.set(M,_*g*A),S.set(d,m*g*A);let b=[A,A,A,A,A,A];x.set(b,p*g*A);}let C=new ui();C.setAttribute("position",new tn(T,_)),C.setAttribute("uv",new tn(S,m)),C.setAttribute("faceIndex",new tn(x,p)),t.push(C),i>Ms&&i--;}return{lodPlanes:t,sizeLods:e,sigmas:n};}function Vh(s,t,e){let n=new Cn(s,t,e);return n.texture.mapping=tr,n.texture.name="PMREM.cubeUv",n.scissorTest=!0,n;}function sa(s,t,e,n,i){s.viewport.set(t,e,n,i),s.scissor.set(t,e,n,i);}function mm(s,t,e){let n=new Float32Array(Bi),i=new N(0,1,0);return new bn({name:"SphericalGaussianBlur",defines:{n:Bi,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/e,CUBEUV_MAX_MIP:`${s}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:n},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:Ol(),fragmentShader:`
		...
		`,blending:Kn,depthTest:!1,depthWrite:!1});}function Gh(){return new bn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Ol(),fragmentShader:`
		...
		`,blending:Kn,depthTest:!1,depthWrite:!1});}function Wh(){return new bn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Ol(),fragmentShader:`
	...
	`;}function gm(s){let t=new WeakMap(),e=null;function n(a){if(a&&a.isTexture){let c=a.mapping,l=c===Mo||c===So,h=c===Oi||c===Di;if(l||h){let u=t.get(a),d=u!==void 0?u.texture.pmremVersion:0;if(a.isRenderTargetTexture&&a.pmremVersion!==d)return e===null&&(e=new oa(s)),u=l?e.fromEquirectangular(a,u):e.fromCubemap(a,u),u.texture.pmremVersion=a.pmremVersion,t.set(a,u),u.texture;if(u!==void 0)return u.texture;{let f=a.image;return l&&f&&f.height>0||h&&f&&i(f)?(e===null&&(e=new oa(s)),u=l?e.fromEquirectangular(a):e.fromCubemap(a),u.texture.pmremVersion=a.pmremVersion,t.set(a,u),a.addEventListener("dispose",r),u.texture):null;}}}return a;}function i(a){let c=0,l=6;for(let h=0;h<l;h++)a[h]!==void 0&&c++;return c===l;}function r(a){let c=a.target;c.removeEventListener("dispose",r);let l=t.get(c);l!==void 0&&(t.delete(c),l.dispose());}function o(){t=new WeakMap(),e!==null&&(e.dispose(),e=null);}return{get:n,dispose:o};}function _m(s){let t={};function e(n){if(t[n]!==void 0)return t[n];let i;switch(n){case"WEBGL_depth_texture":i=s.getExtension("WEBGL_depth_texture")||s.getExtension("MOZ_WEBGL_depth_texture")||s.getExtension("WEBKIT_WEBGL_depth_texture");break;case"EXT_texture_filter_anisotropic":i=s.getExtension("EXT_texture_filter_anisotropic")||s.getExtension("MOZ_EXT_texture_filter_anisotropic")||s.getExtension("WEBKIT_EXT_texture_filter_anisotropic");break;case"WEBGL_compressed_texture_s3tc":i=s.getExtension("WEBGL_compressed_texture_s3tc")||s.getExtension("MOZ_WEBGL_compressed_texture_s3tc")||s.getExtension("WEBKIT_WEBGL_compressed_texture_s3tc");break;case"WEBGL_compressed_texture_pvrtc":i=s.getExtension("WEBGL_compressed_texture_pvrtc")||s.getExtension("WEBKIT_WEBGL_compressed_texture_pvrtc");break;default:i=s.getExtension(n);}return t[n]=i,i;}return{has:function(n){return e(n)!==null;},init:function(){e("EXT_color_buffer_float"),e("WEBGL_clip_cull_distance"),e("OES_texture_float_linear"),e("EXT_color_buffer_half_float"),e("WEBGL_multisampled_render_to_texture"),e("WEBGL_render_shared_exponent");},get:function(n){let i=e(n);return i===null&&Ai("THREE.WebGLRenderer: "+n+" extension not supported."),i;}};}function ym(s,t,e,n){let i={},r=new WeakMap();function o(u){let d=u.target;d.index!==null&&t.remove(d.index);for(let g in d.attributes)t.remove(d.attributes[g]);d.removeEventListener("dispose",o),delete i[d.id];let f=r.get(d);f&&(t.remove(f),r.delete(d)),n.releaseStatesOfGeometry(d),d.isInstancedBufferGeometry===!0&&delete d._maxInstanceCount,e.memory.geometries--;}function a(u,d){return i[d.id]===!0||(d.addEventListener("dispose",o),i[d.id]=!0,e.memory.geometries++),d;}function c(u){let d=u.attributes;for(let f in d)t.update(d[f],s.ARRAY_BUFFER);}function l(u){let d=[],f=u.index,g=u.attributes.position,_=0;if(f!==null){let T=f.array;_=f.version;for(let S=0,x=T.length;S<x;S+=3){let C=T[S+0],A=T[S+1],R=T[S+2];d.push(C,A,A,R,R,C);}}else if(g!==void 0){let T=g.array;_=g.version;for(let S=0,x=T.length/3-1;S<x;S+=3){let C=S+0,A=S+1,R=S+2;d.push(C,A,A,R,R,C);}}else return;let m=new(dl(d)?Ws:Gs)(d,1);m.version=_;let p=r.get(u);p&&t.remove(p),r.set(u,m);}function h(u){let d=r.get(u);if(d){let f=u.index;f!==null&&d.version<f.version&&l(u);}else l(u);return r.get(u);}return{get:a,update:c,getWireframeAttribute:h};}function vm(s,t,e){let n;function i(d){n=d;}let r,o;function a(d){r=d.type,o=d.bytesPerElement;}function c(d,f){s.drawElements(n,f,r,d*o),e.update(f,n,1);}function l(d,f,g){g!==0&&(s.drawElementsInstanced(n,f,r,d*o,g),e.update(f,n,g));}function h(d,f,g){if(g===0)return;t.get("WEBGL_multi_draw").multiDrawElementsWEBGL(n,f,0,r,d,0,g);let m=0;for(let p=0;p<g;p++)m+=f[p];e.update(m,n,1);}function u(d,f,g,_){if(g===0)return;let m=t.get("WEBGL_multi_draw");if(m===null)for(let p=0;p<d.length;p++)l(d[p]/o,f[p],_[p]);else{m.multiDrawElementsInstancedWEBGL(n,f,0,r,d,0,_,0,g);let p=0;for(let T=0;T<g;T++)p+=f[T]*_[T];e.update(p,n,1);}}this.setMode=i,this.setIndex=a,this.render=c,this.renderInstances=l,this.renderMultiDraw=h,this.renderMultiDrawInstances=u;}function xm(s){let t={geometries:0,textures:0},e={frame:0,calls:0,triangles:0,points:0,lines:0};function n(r,o,a){switch(e.calls++,o){case s.TRIANGLES:e.triangles+=a*(r/3);break;case s.LINES:e.lines+=a*(r/2);break;case s.LINE_STRIP:e.lines+=a*(r-1);break;case s.LINE_LOOP:e.lines+=a*r;break;case s.POINTS:e.points+=a*r;break;default:console.error("THREE.WebGLInfo: Unknown draw mode:",o);break;}}function i(){e.calls=0,e.triangles=0,e.points=0,e.lines=0;}return{memory:t,render:e,programs:null,autoReset:!0,reset:i,update:n};}function bm(s,t,e){let n=new WeakMap(),i=new Se();function r(o,a,c){let l=o.morphTargetInfluences,h=a.morphAttributes.position||a.morphAttributes.normal||a.morphAttributes.color,u=h!==void 0?h.length:0,d=n.get(a);if(d===void 0||d.count!==u){let b=function(){O.dispose(),n.delete(a),a.removeEventListener("dispose",b);};var f=b;d!==void 0&&d.texture.dispose();let g=a.morphAttributes.position!==void 0,_=a.morphAttributes.normal!==void 0,m=a.morphAttributes.color!==void 0,p=a.morphAttributes.position||[],T=a.morphAttributes.normal||[],S=a.morphAttributes.color||[],x=0;g===!0&&(x=1),_===!0&&(x=2),m===!0&&(x=3);let C=a.attributes.position.count*x,A=1;C>t.maxTextureSize&&(A=Math.ceil(C/t.maxTextureSize),C=t.maxTextureSize);let R=new Float32Array(C*A*4*u),O=new zs(R,C,A,u);O.type=Ln,O.needsUpdate=!0;let M=x*4;for(let w=0;w<u;w++){let z=p[w],H=T[w],X=S[w],Z=C*A*4*w;for(let Y=0;Y<z.count;Y++){let $=Y*M;g===!0&&(i.fromBufferAttribute(z,Y),R[Z+$+0]=i.x,R[Z+$+1]=i.y,R[Z+$+2]=i.z,R[Z+$+3]=0),_===!0&&(i.fromBufferAttribute(H,Y),R[Z+$+4]=i.x,R[Z+$+5]=i.y,R[Z+$+6]=i.z,R[Z+$+7]=0),m===!0&&(i.fromBufferAttribute(X,Y),R[Z+$+8]=i.x,R[Z+$+9]=i.y,R[Z+$+10]=i.z,R[Z+$+11]=X.itemSize===4?i.w:1);}}d={count:u,texture:O,size:new $t(C,A)},n.set(a,d),a.addEventListener("dispose",b);}if(o.isInstancedMesh===!0&&o.morphTexture!==null)c.getUniforms().setValue(s,"morphTexture",o.morphTexture,e);else{let g=0;for(let m=0;m<l.length;m++)g+=l[m];let _=a.morphTargetsRelative?1:1-g;c.getUniforms().setValue(s,"morphTargetBaseInfluence",_),c.getUniforms().setValue(s,"morphTargetInfluences",l);}c.getUniforms().setValue(s,"morphTargetsTexture",d.texture,e),c.getUniforms().setValue(s,"morphTargetsTextureSize",d.size);}return{update:r};}function Mm(s,t,e,n){let i=new WeakMap();function r(c){let l=n.render.frame,h=c.geometry,u=t.get(c,h);if(i.get(u)!==l&&(t.update(u),i.set(u,l)),c.isInstancedMesh&&(c.hasEventListener("dispose",a)===!1&&c.addEventListener("dispose",a),i.get(c)!==l&&(e.update(c.instanceMatrix,s.ARRAY_BUFFER),c.instanceColor!==null&&e.update(c.instanceColor,s.ARRAY_BUFFER),i.set(c,l))),c.isSkinnedMesh){let d=c.skeleton;i.get(d)!==l&&(d.update(),i.set(d,l));}return u;}function o(){i=new WeakMap();}function a(c){let l=c.target;l.removeEventListener("dispose",a),e.remove(l.instanceMatrix),l.instanceColor!==null&&e.remove(l.instanceColor);}return{update:r,dispose:o};}var cu=new sn(),Xh=new Zs(1,1),hu=new zs(),uu=new Kr(),du=new Ys(),Yh=[],qh=[],Zh=new Float32Array(16),$h=new Float32Array(9),Kh=new Float32Array(4);function Ts(s,t,e){let n=s[0];if(n<=0||n>0)return s;let i=t*e,r=Yh[i];if(r===void 0&&(r=new Float32Array(i),Yh[i]=r),t!==0){n.toArray(r,0);for(let o=1,a=0;o!==t;++o)a+=e,s[o].toArray(r,a);}return r;}function De(s,t){if(s.length!==t.length)return!1;for(let e=0,n=s.length;e<n;e++)if(s[e]!==t[e])return!1;return!0;}function Le(s,t){for(let e=0,n=t.length;e<n;e++)s[e]=t[e];}function la(s,t){let e=qh[t];e===void 0&&(e=new Int32Array(t),qh[t]=e);for(let n=0;n!==t;++n)e[n]=s.allocateTextureUnit();return e;}function Sm(s,t){let e=this.cache;e[0]!==t&&(s.uniform1f(this.addr,t),e[0]=t);}function Tm(s,t){let e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y)&&(s.uniform2f(this.addr,t.x,t.y),e[0]=t.x,e[1]=t.y);else{if(De(e,t))return;s.uniform2fv(this.addr,t),Le(e,t);}}function Em(s,t){let e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z)&&(s.uniform3f(this.addr,t.x,t.y,t.z),e[0]=t.x,e[1]=t.y,e[2]=t.z);else if(t.r!==void 0)(e[0]!==t.r||e[1]!==t.g||e[2]!==t.b)&&(s.uniform3f(this.addr,t.r,t.g,t.b),e[0]=t.r,e[1]=t.g,e[2]=t.b);else{if(De(e,t))return;s.uniform3fv(this.addr,t),Le(e,t);}}function wm(s,t){let e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z||e[3]!==t.w)&&(s.uniform4f(this.addr,t.x,t.y,t.z,t.w),e[0]=t.x,e[1]=t.y,e[2]=t.z,e[3]=t.w);else{if(De(e,t))return;s.uniform4fv(this.addr,t),Le(e,t);}}function Cm(s,t){let e=this.cache,n=t.elements;if(n===void 0){if(De(e,t))return;s.uniformMatrix2fv(this.addr,!1,t),Le(e,t);}else{if(De(e,n))return;Kh.set(n),s.uniformMatrix2fv(this.addr,!1,Kh),Le(e,n);}}function Am(s,t){let e=this.cache,n=t.elements;if(n===void 0){if(De(e,t))return;s.uniformMatrix3fv(this.addr,!1,t),Le(e,t);}else{if(De(e,n))return;$h.set(n),s.uniformMatrix3fv(this.addr,!1,$h),Le(e,n);}}function Pm(s,t){let e=this.cache,n=t.elements;if(n===void 0){if(De(e,t))return;s.uniformMatrix4fv(this.addr,!1,t),Le(e,t);}else{if(De(e,n))return;Zh.set(n),s.uniformMatrix4fv(this.addr,!1,Zh),Le(e,n);}}function Rm(s,t){let e=this.cache;e[0]!==t&&(s.uniform1i(this.addr,t),e[0]=t);}function Im(s,t){let e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y)&&(s.uniform2i(this.addr,t.x,t.y),e[0]=t.x,e[1]=t.y);else{if(De(e,t))return;s.uniform2iv(this.addr,t),Le(e,t);}}function Om(s,t){let e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z)&&(s.uniform3i(this.addr,t.x,t.y,t.z),e[0]=t.x,e[1]=t.y,e[2]=t.z);else{if(De(e,t))return;s.uniform3iv(this.addr,t),Le(e,t);}}function Dm(s,t){let e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z||e[3]!==t.w)&&(s.uniform4i(this.addr,t.x,t.y,t.z,t.w),e[0]=t.x,e[1]=t.y,e[2]=t.z,e[3]=t.w);else{if(De(e,t))return;s.uniform4iv(this.addr,t),Le(e,t);}}function Lm(s,t){let e=this.cache;e[0]!==t&&(s.uniform1ui(this.addr,t),e[0]=t);}function Fm(s,t){let e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y)&&(s.uniform2ui(this.addr,t.x,t.y),e[0]=t.x,e[1]=t.y);else{if(De(e,t))return;s.uniform2uiv(this.addr,t),Le(e,t);}}function Nm(s,t){let e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z)&&(s.uniform3ui(this.addr,t.x,t.y,t.z),e[0]=t.x,e[1]=t.y,e[2]=t.z);else{if(De(e,t))return;s.uniform3uiv(this.addr,t),Le(e,t);}}function Um(s,t){let e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z||e[3]!==t.w)&&(s.uniform4ui(this.addr,t.x,t.y,t.z,t.w),e[0]=t.x,e[1]=t.y,e[2]=t.z,e[3]=t.w);else{if(De(e,t))return;s.uniform4uiv(this.addr,t),Le(e,t);}}function Bm(s,t,e){let n=this.cache,i=e.allocateTextureUnit();n[0]!==i&&(s.uniform1i(this.addr,i),n[0]=i);let r;this.type===s.SAMPLER_2D_SHADOW?(Xh.compareFunction=cl,r=Xh):r=cu,e.setTexture2D(t||r,i);}function Hm(s,t,e){let n=this.cache,i=e.allocateTextureUnit();n[0]!==i&&(s.uniform1i(this.addr,i),n[0]=i),e.setTexture3D(t||uu,i);}function km(s,t,e){let n=this.cache,i=e.allocateTextureUnit();n[0]!==i&&(s.uniform1i(this.addr,i),n[0]=i),e.setTextureCube(t||du,i);}function zm(s,t,e){let n=this.cache,i=e.allocateTextureUnit();n[0]!==i&&(s.uniform1i(this.addr,i),n[0]=i),e.setTexture2DArray(t||hu,i);}function Vm(s){switch(s){case 5126:return Sm;case 35664:return Tm;case 35665:return Em;case 35666:return wm;case 35674:return Cm;case 35675:return Am;case 35676:return Pm;case 5124:case 35670:return Rm;case 35667:case 35671:return Im;case 35668:case 35672:return Om;case 35669:case 35673:return Dm;case 5125:return Lm;case 36294:return Fm;case 36295:return Nm;case 36296:return Um;case 35678:case 36198:case 36298:case 36306:case 35682:return Bm;case 35679:case 36299:case 36307:return Hm;case 35680:case 36300:case 36308:case 36293:return km;case 36289:case 36303:case 36311:case 36292:return zm;}}function Gm(s,t){s.uniform1fv(this.addr,t);}function Wm(s,t){let e=Ts(t,this.size,2);s.uniform2fv(this.addr,e);}function Xm(s,t){let e=Ts(t,this.size,3);s.uniform3fv(this.addr,e);}function Ym(s,t){let e=Ts(t,this.size,4);s.uniform4fv(this.addr,e);}function qm(s,t){let e=Ts(t,this.size,4);s.uniformMatrix2fv(this.addr,!1,e);}function Zm(s,t){let e=Ts(t,this.size,9);s.uniformMatrix3fv(this.addr,!1,e);}function $m(s,t){let e=Ts(t,this.size,16);s.uniformMatrix4fv(this.addr,!1,e);}function Km(s,t){s.uniform1iv(this.addr,t);}function Jm(s,t){s.uniform2iv(this.addr,t);}function jm(s,t){s.uniform3iv(this.addr,t);}function Qm(s,t){s.uniform4iv(this.addr,t);}function tg(s,t){s.uniform1uiv(this.addr,t);}function eg(s,t){s.uniform2uiv(this.addr,t);}function ng(s,t){s.uniform3uiv(this.addr,t);}function ig(s,t){s.uniform4uiv(this.addr,t);}function sg(s,t,e){let n=this.cache,i=t.length,r=la(e,i);De(n,r)||(s.uniform1iv(this.addr,r),Le(n,r));for(let o=0;o!==i;++o)e.setTexture2D(t[o]||cu,r[o]);}function rg(s,t,e){let n=this.cache,i=t.length,r=la(e,i);De(n,r)||(s.uniform1iv(this.addr,r),Le(n,r));for(let o=0;o!==i;++o)e.setTexture3D(t[o]||uu,r[o]);}function og(s,t,e){let n=this.cache,i=t.length,r=la(e,i);De(n,r)||(s.uniform1iv(this.addr,r),Le(n,r));for(let o=0;o!==i;++o)e.setTextureCube(t[o]||du,r[o]);}function ag(s,t,e){let n=this.cache,i=t.length,r=la(e,i);De(n,r)||(s.uniform1iv(this.addr,r),Le(n,r));for(let o=0;o!==i;++o)e.setTexture2DArray(t[o]||hu,r[o]);}function lg(s){switch(s){case 5126:return Gm;case 35664:return Wm;case 35665:return Xm;case 35666:return Ym;case 35674:return qm;case 35675:return Zm;case 35676:return $m;case 5124:case 35670:return Km;case 35667:case 35671:return Jm;case 35668:case 35672:return jm;case 35669:case 35673:return Qm;case 5125:return tg;case 36294:return eg;case 36295:return ng;case 36296:return ig;case 35678:case 36198:case 36298:case 36306:case 35682:return sg;case 35679:case 36299:case 36307:return rg;case 35680:case 36300:case 36308:case 36293:return og;case 36289:case 36303:case 36311:case 36292:return ag;}}var Tl=class{constructor(t,e,n){this.id=t,this.addr=n,this.cache=[],this.type=e.type,this.setValue=Vm(e.type);}},El=class{constructor(t,e,n){this.id=t,this.addr=n,this.cache=[],this.type=e.type,this.size=e.size,this.setValue=lg(e.type);}},wl=class{constructor(t){this.id=t,this.seq=[],this.map={};}setValue(t,e,n){let i=this.seq;for(let r=0,o=i.length;r!==o;++r){let a=i[r];a.setValue(t,e[a.id],n);}}},Sl=/(\w+)(\])?(\[|\.)?/g;function Jh(s,t){s.seq.push(t),s.map[t.id]=t;}function cg(s,t,e){let n=s.name,i=n.length;for(Sl.lastIndex=0;;){let r=Sl.exec(n),o=Sl.lastIndex,a=r[1],c=r[2]==="]",l=r[3];if(c&&(a=a|0),l===void 0||l==="["&&o+2===i){Jh(e,l===void 0?new Tl(a,s,t):new El(a,s,t));break;}else{let u=e.map[a];u===void 0&&(u=new wl(a),Jh(e,u)),e=u;}}}var Ss=class{constructor(t,e){this.seq=[],this.map={};let n=t.getProgramParameter(e,t.ACTIVE_UNIFORMS);for(let i=0;i<n;++i){let r=t.getActiveUniform(e,i),o=t.getUniformLocation(e,r.name);cg(r,o,this);}}setValue(t,e,n,i){let r=this.map[e];r!==void 0&&r.setValue(t,n,i);}setOptional(t,e,n){let i=e[n];i!==void 0&&this.setValue(t,n,i);}static upload(t,e,n,i){for(let r=0,o=e.length;r!==o;++r){let a=e[r],c=n[a.id];c.needsUpdate!==!1&&a.setValue(t,c.value,i);}}static seqWithValue(t,e){let n=[];for(let i=0,r=t.length;i!==r;++i){let o=t[i];o.id in e&&n.push(o);}return n;}};function jh(s,t,e){let n=s.createShader(t);return s.shaderSource(n,e),s.compileShader(n),n;}var hg=37297,ug=0;function dg(s,t){let e=s.split(`
`),n=[],i=Math.max(t-6,0),r=Math.min(t+6,e.length);for(let o=i;o<r;o++){let a=o+1;n.push(`${a===t?">":" "} ${a}: ${e[o]}`);}return n.join(`
`);}var Qh=new Ht();function fg(s){Jt._getMatrix(Qh,Jt.workingColorSpace,s);let t=`mat3( ${Qh.elements.map(e=>e.toFixed(4))} )`;switch(Jt.getTransfer(s)){case Hs:return[t,"LinearTransferOETF"];case oe:return[t,"sRGBTransferOETF"];default:return console.warn("THREE.WebGLProgram: Unsupported color space: ",s),[t,"LinearTransferOETF"];}}function tu(s,t,e){let n=s.getShaderParameter(t,s.COMPILE_STATUS),r=(s.getShaderInfoLog(t)||"").trim();if(n&&r==="")return"";let o=/ERROR: 0:(\d+)/.exec(r);if(o){let a=parseInt(o[1]);return e.toUpperCase()+`

`+r+`

`+dg(s.getShaderSource(t),a);}else return r;}function pg(s,t){let e=fg(t);return[`vec4 ${s}( vec4 value ) {`,`	return ${e[1]}( vec4( value.rgb * ${e[0]}, value.a ) );`,"}"].join(`
`);}function mg(s,t){let e;switch(t){case mh:e="Linear";break;case gh:e="Reinhard";break;case _h:e="Cineon";break;case yh:e="ACESFilmic";break;case xh:e="AgX";break;case bh:e="Neutral";break;case vh:e="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",t),e="Linear";}return"vec3 "+s+"( vec3 color ) { return "+e+"ToneMapping( color ); }";}var ra=new N();function gg(){Jt.getLuminanceCoefficients(ra);let s=ra.x.toFixed(4),t=ra.y.toFixed(4),e=ra.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${s}, ${t}, ${e} );`,"	return dot( weights, rgb );","}"].join(`
...
`);}function yg(s){let t=[];for(let e in s){let n=s[e];n!==!1&&t.push("#define "+e+" "+n);}return t.join(`
`);}function vg(s,t){let e={},n=s.getProgramParameter(t,s.ACTIVE_ATTRIBUTES);for(let i=0;i<n;i++){let r=s.getActiveAttrib(t,i),o=r.name,a=1;r.type===s.FLOAT_MAT2&&(a=2),r.type===s.FLOAT_MAT3&&(a=3),r.type===s.FLOAT_MAT4&&(a=4),e[o]={type:r.type,location:s.getAttribLocation(t,o),locationSize:a};}return e;}function ar(s){return s!=="";}function eu(s,t){let e=t.numSpotLightShadows+t.numSpotLightMaps-t.numSpotLightShadowsWithMaps;return s.replace(/NUM_DIR_LIGHTS/g,t.numDirLights).replace(/NUM_SPOT_LIGHTS/g,t.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,t.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,e).replace(/NUM_RECT_AREA_LIGHTS/g,t.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,t.numPointLights).replace(/NUM_HEMI_LIGHTS/g,t.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,t.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,t.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,t.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,t.numPointLightShadows);}function nu(s,t){return s.replace(/NUM_CLIPPING_PLANES/g,t.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,t.numClippingPlanes-t.numClipIntersection);}var xg=/^[ \t]*#include +<([\w\d./]+)>/gm;function Cl(s){return s.replace(xg,Mg);}var bg=new Map();function Mg(s,t){let e=Vt[t];if(e===void 0){let n=bg.get(t);if(n!==void 0)e=Vt[n],console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',t,n);else throw new Error("Can not resolve #include <"+t+">");}return Cl(e);}var Sg=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function iu(s){return s.replace(Sg,Tg);}function Tg(s,t,e,n){let i="";for(let r=parseInt(t);r<parseInt(e);r++)i+=n.replace(/\[\s*i\s*\]/g,"[ "+r+" ]").replace(/UNROLLED_LOOP_INDEX/g,r);return i;}function su(s){let t=`precision ${s.precision} float;
...
#define LOW_PRECISION`),t;}function Eg(s){let t="SHADOWMAP_TYPE_BASIC";return s.shadowMapType===Ka?t="SHADOWMAP_TYPE_PCF":s.shadowMapType===Zc?t="SHADOWMAP_TYPE_PCF_SOFT":s.shadowMapType===Rn&&(t="SHADOWMAP_TYPE_VSM"),t;}function wg(s){let t="ENVMAP_TYPE_CUBE";if(s.envMap)switch(s.envMapMode){case Oi:case Di:t="ENVMAP_TYPE_CUBE";break;case tr:t="ENVMAP_TYPE_CUBE_UV";break;}return t;}function Cg(s){let t="ENVMAP_MODE_REFLECTION";if(s.envMap)switch(s.envMapMode){case Di:t="ENVMAP_MODE_REFRACTION";break;}return t;}function Ag(s){let t="ENVMAP_BLENDING_NONE";if(s.envMap)switch(s.combine){case tl:t="ENVMAP_BLENDING_MULTIPLY";break;case fh:t="ENVMAP_BLENDING_MIX";break;case ph:t="ENVMAP_BLENDING_ADD";break;}return t;}function Pg(s){let t=s.envMapCubeUVHeight;if(t===null)return null;let e=Math.log2(t)-2,n=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,e),7*16)),texelHeight:n,maxMip:e};}function Rg(s,t,e,n){let i=s.getContext(),r=e.defines,o=e.vertexShader,a=e.fragmentShader,c=Eg(e),l=wg(e),h=Cg(e),u=Ag(e),d=Pg(e),f=_g(e),g=yg(r),_=i.createProgram(),m,p,T=e.glslVersion?"#version "+e.glslVersion+`
...
`)+`
`+p);let S=T+m+o,x=T+p+a,C=jh(i,i.VERTEX_SHADER,S),A=jh(i,i.FRAGMENT_SHADER,x);i.attachShader(_,C),i.attachShader(_,A),e.index0AttributeName!==void 0?i.bindAttribLocation(_,0,e.index0AttributeName):e.morphTargets===!0&&i.bindAttribLocation(_,0,"position"),i.linkProgram(_);function R(w){if(s.debug.checkShaderErrors){let z=i.getProgramInfoLog(_)||"",H=i.getShaderInfoLog(C)||"",X=i.getShaderInfoLog(A)||"",Z=z.trim(),Y=H.trim(),$=X.trim(),k=!0,at=!0;if(i.getProgramParameter(_,i.LINK_STATUS)===!1){if(k=!1,typeof s.debug.onShaderError=="function")s.debug.onShaderError(i,_,C,A);else{let dt=tu(i,C,"vertex"),wt=tu(i,A,"fragment");console.error("THREE.WebGLProgram: Shader Error "+i.getError()+" - VALIDATE_STATUS "+i.getProgramParameter(_,i.VALIDATE_STATUS)+`
...
Program Info Log: `+Z+`
`+dt+`
`+wt);}}else Z!==""?console.warn("THREE.WebGLProgram: Program Info Log:",Z):(Y===""||$==="")&&(at=!1);at&&(w.diagnostics={runnable:k,programLog:Z,vertexShader:{log:Y,prefix:m},fragmentShader:{log:$,prefix:p}});}i.deleteShader(C),i.deleteShader(A),O=new Ss(i,_),M=vg(i,_);}let O;this.getUniforms=function(){return O===void 0&&R(this),O;};let M;this.getAttributes=function(){return M===void 0&&R(this),M;};let b=e.rendererExtensionParallelShaderCompile===!1;return this.isReady=function(){return b===!1&&(b=i.getProgramParameter(_,hg)),b;},this.destroy=function(){n.releaseStatesOfProgram(this),i.deleteProgram(_),this.program=void 0;},this.type=e.shaderType,this.name=e.shaderName,this.id=ug++,this.cacheKey=t,this.usedTimes=1,this.program=_,this.vertexShader=C,this.fragmentShader=A,this;}var Ig=0,Al=class{constructor(){this.shaderCache=new Map(),this.materialCache=new Map();}update(t){let e=t.vertexShader,n=t.fragmentShader,i=this._getShaderStage(e),r=this._getShaderStage(n),o=this._getShaderCacheForMaterial(t);return o.has(i)===!1&&(o.add(i),i.usedTimes++),o.has(r)===!1&&(o.add(r),r.usedTimes++),this;}remove(t){let e=this.materialCache.get(t);for(let n of e)n.usedTimes--,n.usedTimes===0&&this.shaderCache.delete(n.code);return this.materialCache.delete(t),this;}getVertexShaderID(t){return this._getShaderStage(t.vertexShader).id;}getFragmentShaderID(t){return this._getShaderStage(t.fragmentShader).id;}dispose(){this.shaderCache.clear(),this.materialCache.clear();}_getShaderCacheForMaterial(t){let e=this.materialCache,n=e.get(t);return n===void 0&&(n=new Set(),e.set(t,n)),n;}_getShaderStage(t){let e=this.shaderCache,n=e.get(t);return n===void 0&&(n=new Pl(t),e.set(t,n)),n;}},Pl=class{constructor(t){this.id=Ig++,this.code=t,this.usedTimes=0;}};function Og(s,t,e,n,i,r,o){let a=new fs(),c=new Al(),l=new Set(),h=[],u=i.logarithmicDepthBuffer,d=i.vertexTextures,f=i.precision,g={MeshDepthMaterial:"depth",MeshDistanceMaterial:"distanceRGBA",MeshNormalMaterial:"normal",MeshBasicMaterial:"basic",MeshLambertMaterial:"lambert",MeshPhongMaterial:"phong",MeshToonMaterial:"toon",MeshStandardMaterial:"physical",MeshPhysicalMaterial:"physical",MeshMatcapMaterial:"matcap",LineBasicMaterial:"basic",LineDashedMaterial:"dashed",PointsMaterial:"points",ShadowMaterial:"shadow",SpriteMaterial:"sprite"};function _(M){return l.add(M),M===0?"uv":`uv${M}`;}function m(M,b,w,z,H){let X=z.fog,Z=H.geometry,Y=M.isMeshStandardMaterial?z.environment:null,$=(M.isMeshStandardMaterial?e:t).get(M.envMap||Y),k=$&&$.mapping===tr?$.image.height:null,at=g[M.type];M.precision!==null&&(f=i.getMaxPrecision(M.precision),f!==M.precision&&console.warn("THREE.WebGLProgram.getParameters:",M.precision,"not supported, using",f,"instead."));let dt=Z.morphAttributes.position||Z.morphAttributes.normal||Z.morphAttributes.color,wt=dt!==void 0?dt.length:0,Gt=0;Z.morphAttributes.position!==void 0&&(Gt=1),Z.morphAttributes.normal!==void 0&&(Gt=2),Z.morphAttributes.color!==void 0&&(Gt=3);let me,ce,W,lt;if(at){let re=Fn[at];me=re.vertexShader,ce=re.fragmentShader;}else me=M.vertexShader,ce=M.fragmentShader,c.update(M),W=c.getVertexShaderID(M),lt=c.getFragmentShaderID(M);let it=s.getRenderTarget(),Rt=s.state.buffers.depth.getReversed(),It=H.isInstancedMesh===!0,Ut=H.isBatchedMesh===!0,Te=!!M.map,Kt=!!M.matcap,P=!!$,ue=!!M.aoMap,At=!!M.lightMap,ee=!!M.bumpMap,Tt=!!M.normalMap,ge=!!M.displacementMap,mt=!!M.emissiveMap,Wt=!!M.metalnessMap,Fe=!!M.roughnessMap,Ee=M.anisotropy>0,E=M.clearcoat>0,y=M.dispersion>0,F=M.iridescence>0,G=M.sheen>0,K=M.transmission>0,V=Ee&&!!M.anisotropyMap,St=E&&!!M.clearcoatMap,nt=E&&!!M.clearcoatNormalMap,xt=E&&!!M.clearcoatRoughnessMap,bt=F&&!!M.iridescenceMap,tt=F&&!!M.iridescenceThicknessMap,ut=G&&!!M.sheenColorMap,Dt=G&&!!M.sheenRoughnessMap,Mt=!!M.specularMap,ct=!!M.specularColorMap,kt=!!M.specularIntensityMap,I=K&&!!M.transmissionMap,et=K&&!!M.thicknessMap,st=!!M.gradientMap,pt=!!M.alphaMap,J=M.alphaTest>0,q=!!M.alphaHash,yt=!!M.extensions,Bt=Jn;M.toneMapped&&(it===null||it.isXRRenderTarget===!0)&&(Bt=s.toneMapping);let de={shaderID:at,shaderType:M.type,shaderName:M.name,vertexShader:me,fragmentShader:ce,defines:M.defines,customVertexShaderID:W,customFragmentShaderID:lt,isRawShaderMaterial:M.isRawShaderMaterial===!0,glslVersion:M.glslVersion,precision:f,batching:Ut,batchingColor:Ut&&H._colorsTexture!==null,instancing:It,instancingColor:It&&H.instanceColor!==null,instancingMorph:It&&H.morphTexture!==null,supportsVertexTextures:d,outputColorSpace:it===null?s.outputColorSpace:it.isXRRenderTarget===!0?it.texture.colorSpace:Ci,alphaToCoverage:!!M.alphaToCoverage,map:Te,matcap:Kt,envMap:P,envMapMode:P&&$.mapping,envMapCubeUVHeight:k,aoMap:ue,lightMap:At,bumpMap:ee,normalMap:Tt,displacementMap:d&&ge,emissiveMap:mt,normalMapObjectSpace:Tt&&M.normalMapType===wh,normalMapTangentSpace:Tt&&M.normalMapType===Eh,metalnessMap:Wt,roughnessMap:Fe,anisotropy:Ee,anisotropyMap:V,clearcoat:E,clearcoatMap:St,clearcoatNormalMap:nt,clearcoatRoughnessMap:xt,dispersion:y,iridescence:F,iridescenceMap:bt,iridescenceThicknessMap:tt,sheen:G,sheenColorMap:ut,sheenRoughnessMap:Dt,specularMap:Mt,specularColorMap:ct,specularIntensityMap:kt,transmission:K,transmissionMap:I,thicknessMap:et,gradientMap:st,opaque:M.transparent===!1&&M.blending===Ei&&M.alphaToCoverage===!1,alphaMap:pt,alphaTest:J,alphaHash:q,combine:M.combine,mapUv:Te&&_(M.map.channel),aoMapUv:ue&&_(M.aoMap.channel),lightMapUv:At&&_(M.lightMap.channel),bumpMapUv:ee&&_(M.bumpMap.channel),normalMapUv:Tt&&_(M.normalMap.channel),displacementMapUv:ge&&_(M.displacementMap.channel),emissiveMapUv:mt&&_(M.emissiveMap.channel),metalnessMapUv:Wt&&_(M.metalnessMap.channel),roughnessMapUv:Fe&&_(M.roughnessMap.channel),anisotropyMapUv:V&&_(M.anisotropyMap.channel),clearcoatMapUv:St&&_(M.clearcoatMap.channel),clearcoatNormalMapUv:nt&&_(M.clearcoatNormalMap.channel),clearcoatRoughnessMapUv:xt&&_(M.clearcoatRoughnessMap.channel),iridescenceMapUv:bt&&_(M.iridescenceMap.channel),iridescenceThicknessMapUv:tt&&_(M.iridescenceThicknessMap.channel),sheenColorMapUv:ut&&_(M.sheenColorMap.channel),sheenRoughnessMapUv:Dt&&_(M.sheenRoughnessMap.channel),specularMapUv:Mt&&_(M.specularMap.channel),specularColorMapUv:ct&&_(M.specularColorMap.channel),specularIntensityMapUv:kt&&_(M.specularIntensityMap.channel),transmissionMapUv:I&&_(M.transmissionMap.channel),thicknessMapUv:et&&_(M.thicknessMap.channel),alphaMapUv:pt&&_(M.alphaMap.channel),vertexTangents:!!Z.attributes.tangent&&(Tt||Ee),vertexColors:M.vertexColors,vertexAlphas:M.vertexColors===!0&&!!Z.attributes.color&&Z.attributes.color.itemSize===4,pointsUvs:H.isPoints===!0&&!!Z.attributes.uv&&(Te||pt),fog:!!X,useFog:M.fog===!0,fogExp2:!!X&&X.isFogExp2,flatShading:M.flatShading===!0&&M.wireframe===!1,sizeAttenuation:M.sizeAttenuation===!0,logarithmicDepthBuffer:u,reversedDepthBuffer:Rt,skinning:H.isSkinnedMesh===!0,morphTargets:Z.morphAttributes.position!==void 0,morphNormals:Z.morphAttributes.normal!==void 0,morphColors:Z.morphAttributes.color!==void 0,morphTargetsCount:wt,morphTextureStride:Gt,numDirLights:b.directional.length,numPointLights:b.point.length,numSpotLights:b.spot.length,numSpotLightMaps:b.spotLightMap.length,numRectAreaLights:b.rectArea.length,numHemiLights:b.hemi.length,numDirLightShadows:b.directionalShadowMap.length,numPointLightShadows:b.pointShadowMap.length,numSpotLightShadows:b.spotShadowMap.length,numSpotLightShadowsWithMaps:b.numSpotLightShadowsWithMaps,numLightProbes:b.numLightProbes,numClippingPlanes:o.numPlanes,numClipIntersection:o.numIntersection,dithering:M.dithering,shadowMapEnabled:s.shadowMap.enabled&&w.length>0,shadowMapType:s.shadowMap.type,toneMapping:Bt,decodeVideoTexture:Te&&M.map.isVideoTexture===!0&&Jt.getTransfer(M.map.colorSpace)===oe,decodeVideoTextureEmissive:mt&&M.emissiveMap.isVideoTexture===!0&&Jt.getTransfer(M.emissiveMap.colorSpace)===oe,premultipliedAlpha:M.premultipliedAlpha,doubleSided:M.side===In,flipSided:M.side===Ye,useDepthPacking:M.depthPacking>=0,depthPacking:M.depthPacking||0,index0AttributeName:M.index0AttributeName,extensionClipCullDistance:yt&&M.extensions.clipCullDistance===!0&&n.has("WEBGL_clip_cull_distance"),extensionMultiDraw:(yt&&M.extensions.multiDraw===!0||Ut)&&n.has("WEBGL_multi_draw"),rendererExtensionParallelShaderCompile:n.has("KHR_parallel_shader_compile"),customProgramCacheKey:M.customProgramCacheKey()};return de.vertexUv1s=l.has(1),de.vertexUv2s=l.has(2),de.vertexUv3s=l.has(3),l.clear(),de;}function p(M){let b=[];if(M.shaderID?b.push(M.shaderID):(b.push(M.customVertexShaderID),b.push(M.customFragmentShaderID)),M.defines!==void 0)for(let w in M.defines)b.push(w),b.push(M.defines[w]);return M.isRawShaderMaterial===!1&&(T(b,M),S(b,M),b.push(s.outputColorSpace)),b.push(M.customProgramCacheKey),b.join();}function T(M,b){M.push(b.precision),M.push(b.outputColorSpace),M.push(b.envMapMode),M.push(b.envMapCubeUVHeight),M.push(b.mapUv),M.push(b.alphaMapUv),M.push(b.lightMapUv),M.push(b.aoMapUv),M.push(b.bumpMapUv),M.push(b.normalMapUv),M.push(b.displacementMapUv),M.push(b.emissiveMapUv),M.push(b.metalnessMapUv),M.push(b.roughnessMapUv),M.push(b.anisotropyMapUv),M.push(b.clearcoatMapUv),M.push(b.clearcoatNormalMapUv),M.push(b.clearcoatRoughnessMapUv),M.push(b.iridescenceMapUv),M.push(b.iridescenceThicknessMapUv),M.push(b.sheenColorMapUv),M.push(b.sheenRoughnessMapUv),M.push(b.specularMapUv),M.push(b.specularColorMapUv),M.push(b.specularIntensityMapUv),M.push(b.transmissionMapUv),M.push(b.thicknessMapUv),M.push(b.combine),M.push(b.fogExp2),M.push(b.sizeAttenuation),M.push(b.morphTargetsCount),M.push(b.morphAttributeCount),M.push(b.numDirLights),M.push(b.numPointLights),M.push(b.numSpotLights),M.push(b.numSpotLightMaps),M.push(b.numHemiLights),M.push(b.numRectAreaLights),M.push(b.numDirLightShadows),M.push(b.numPointLightShadows),M.push(b.numSpotLightShadows),M.push(b.numSpotLightShadowsWithMaps),M.push(b.numLightProbes),M.push(b.shadowMapType),M.push(b.toneMapping),M.push(b.numClippingPlanes),M.push(b.numClipIntersection),M.push(b.depthPacking);}function S(M,b){a.disableAll(),b.supportsVertexTextures&&a.enable(0),b.instancing&&a.enable(1),b.instancingColor&&a.enable(2),b.instancingMorph&&a.enable(3),b.matcap&&a.enable(4),b.envMap&&a.enable(5),b.normalMapObjectSpace&&a.enable(6),b.normalMapTangentSpace&&a.enable(7),b.clearcoat&&a.enable(8),b.iridescence&&a.enable(9),b.alphaTest&&a.enable(10),b.vertexColors&&a.enable(11),b.vertexAlphas&&a.enable(12),b.vertexUv1s&&a.enable(13),b.vertexUv2s&&a.enable(14),b.vertexUv3s&&a.enable(15),b.vertexTangents&&a.enable(16),b.anisotropy&&a.enable(17),b.alphaHash&&a.enable(18),b.batching&&a.enable(19),b.dispersion&&a.enable(20),b.batchingColor&&a.enable(21),b.gradientMap&&a.enable(22),M.push(a.mask),a.disableAll(),b.fog&&a.enable(0),b.useFog&&a.enable(1),b.flatShading&&a.enable(2),b.logarithmicDepthBuffer&&a.enable(3),b.reversedDepthBuffer&&a.enable(4),b.skinning&&a.enable(5),b.morphTargets&&a.enable(6),b.morphNormals&&a.enable(7),b.morphColors&&a.enable(8),b.premultipliedAlpha&&a.enable(9),b.shadowMapEnabled&&a.enable(10),b.doubleSided&&a.enable(11),b.flipSided&&a.enable(12),b.useDepthPacking&&a.enable(13),b.dithering&&a.enable(14),b.transmission&&a.enable(15),b.sheen&&a.enable(16),b.opaque&&a.enable(17),b.pointsUvs&&a.enable(18),b.decodeVideoTexture&&a.enable(19),b.decodeVideoTextureEmissive&&a.enable(20),b.alphaToCoverage&&a.enable(21),M.push(a.mask);}function x(M){let b=g[M.type],w;if(b){let z=Fn[b];w=Uh.clone(z.uniforms);}else w=M.uniforms;return w;}function C(M,b){let w;for(let z=0,H=h.length;z<H;z++){let X=h[z];if(X.cacheKey===b){w=X,++w.usedTimes;break;}}return w===void 0&&(w=new Rg(s,b,M,r),h.push(w)),w;}function A(M){if(--M.usedTimes===0){let b=h.indexOf(M);h[b]=h[h.length-1],h.pop(),M.destroy();}}function R(M){c.remove(M);}function O(){c.dispose();}return{getParameters:m,getProgramCacheKey:p,getUniforms:x,acquireProgram:C,releaseProgram:A,releaseShaderCache:R,programs:h,dispose:O};}function Dg(){let s=new WeakMap();function t(o){return s.has(o);}function e(o){let a=s.get(o);return a===void 0&&(a={},s.set(o,a)),a;}function n(o){s.delete(o);}function i(o,a,c){s.get(o)[a]=c;}function r(){s=new WeakMap();}return{has:t,get:e,remove:n,update:i,dispose:r};}function Lg(s,t){return s.groupOrder!==t.groupOrder?s.groupOrder-t.groupOrder:s.renderOrder!==t.renderOrder?s.renderOrder-t.renderOrder:s.material.id!==t.material.id?s.material.id-t.material.id:s.z!==t.z?s.z-t.z:s.id-t.id;}function ru(s,t){return s.groupOrder!==t.groupOrder?s.groupOrder-t.groupOrder:s.renderOrder!==t.renderOrder?s.renderOrder-t.renderOrder:s.z!==t.z?t.z-s.z:s.id-t.id;}function ou(){let s=[],t=0,e=[],n=[],i=[];function r(){t=0,e.length=0,n.length=0,i.length=0;}function o(u,d,f,g,_,m){let p=s[t];return p===void 0?(p={id:u.id,object:u,geometry:d,material:f,groupOrder:g,renderOrder:u.renderOrder,z:_,group:m},s[t]=p):(p.id=u.id,p.object=u,p.geometry=d,p.material=f,p.groupOrder=g,p.renderOrder=u.renderOrder,p.z=_,p.group=m),t++,p;}function a(u,d,f,g,_,m){let p=o(u,d,f,g,_,m);f.transmission>0?n.push(p):f.transparent===!0?i.push(p):e.push(p);}function c(u,d,f,g,_,m){let p=o(u,d,f,g,_,m);f.transmission>0?n.unshift(p):f.transparent===!0?i.unshift(p):e.unshift(p);}function l(u,d){e.length>1&&e.sort(u||Lg),n.length>1&&n.sort(d||ru),i.length>1&&i.sort(d||ru);}function h(){for(let u=t,d=s.length;u<d;u++){let f=s[u];if(f.id===null)break;f.id=null,f.object=null,f.geometry=null,f.material=null,f.group=null;}}return{opaque:e,transmissive:n,transparent:i,init:r,push:a,unshift:c,finish:h,sort:l};}function Fg(){let s=new WeakMap();function t(n,i){let r=s.get(n),o;return r===void 0?(o=new ou(),s.set(n,[o])):i>=r.length?(o=new ou(),r.push(o)):o=r[i],o;}function e(){s=new WeakMap();}return{get:t,dispose:e};}function Ng(){let s={};return{get:function(t){if(s[t.id]!==void 0)return s[t.id];let e;switch(t.type){case"DirectionalLight":e={direction:new N(),color:new Qt()};break;case"SpotLight":e={position:new N(),direction:new N(),color:new Qt(),distance:0,coneCos:0,penumbraCos:0,decay:0};break;case"PointLight":e={position:new N(),color:new Qt(),distance:0,decay:0};break;case"HemisphereLight":e={direction:new N(),skyColor:new Qt(),groundColor:new Qt()};break;case"RectAreaLight":e={color:new Qt(),position:new N(),halfWidth:new N(),halfHeight:new N()};break;}return s[t.id]=e,e;}};}function Ug(){let s={};return{get:function(t){if(s[t.id]!==void 0)return s[t.id];let e;switch(t.type){case"DirectionalLight":e={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new $t()};break;case"SpotLight":e={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new $t()};break;case"PointLight":e={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new $t(),shadowCameraNear:1,shadowCameraFar:1e3};break;}return s[t.id]=e,e;}};}var Bg=0;function Hg(s,t){return(t.castShadow?2:0)-(s.castShadow?2:0)+(t.map?1:0)-(s.map?1:0);}function kg(s){let t=new Ng(),e=Ug(),n={version:0,hash:{directionalLength:-1,pointLength:-1,spotLength:-1,rectAreaLength:-1,hemiLength:-1,numDirectionalShadows:-1,numPointShadows:-1,numSpotShadows:-1,numSpotMaps:-1,numLightProbes:-1},ambient:[0,0,0],probe:[],directional:[],directionalShadow:[],directionalShadowMap:[],directionalShadowMatrix:[],spot:[],spotLightMap:[],spotShadow:[],spotShadowMap:[],spotLightMatrix:[],rectArea:[],rectAreaLTC1:null,rectAreaLTC2:null,point:[],pointShadow:[],pointShadowMap:[],pointShadowMatrix:[],hemi:[],numSpotLightShadowsWithMaps:0,numLightProbes:0};for(let l=0;l<9;l++)n.probe.push(new N());let i=new N(),r=new Me(),o=new Me();function a(l){let h=0,u=0,d=0;for(let M=0;M<9;M++)n.probe[M].set(0,0,0);let f=0,g=0,_=0,m=0,p=0,T=0,S=0,x=0,C=0,A=0,R=0;l.sort(Hg);for(let M=0,b=l.length;M<b;M++){let w=l[M],z=w.color,H=w.intensity,X=w.distance,Z=w.shadow&&w.shadow.map?w.shadow.map.texture:null;if(w.isAmbientLight)h+=z.r*H,u+=z.g*H,d+=z.b*H;else if(w.isLightProbe){for(let Y=0;Y<9;Y++)n.probe[Y].addScaledVector(w.sh.coefficients[Y],H);R++;}else if(w.isDirectionalLight){let Y=t.get(w);if(Y.color.copy(w.color).multiplyScalar(w.intensity),w.castShadow){let $=w.shadow,k=e.get(w);k.shadowIntensity=$.intensity,k.shadowBias=$.bias,k.shadowNormalBias=$.normalBias,k.shadowRadius=$.radius,k.shadowMapSize=$.mapSize,n.directionalShadow[f]=k,n.directionalShadowMap[f]=Z,n.directionalShadowMatrix[f]=w.shadow.matrix,T++;}n.directional[f]=Y,f++;}else if(w.isSpotLight){let Y=t.get(w);Y.position.setFromMatrixPosition(w.matrixWorld),Y.color.copy(z).multiplyScalar(H),Y.distance=X,Y.coneCos=Math.cos(w.angle),Y.penumbraCos=Math.cos(w.angle*(1-w.penumbra)),Y.decay=w.decay,n.spot[_]=Y;let $=w.shadow;if(w.map&&(n.spotLightMap[C]=w.map,C++,$.updateMatrices(w),w.castShadow&&A++),n.spotLightMatrix[_]=$.matrix,w.castShadow){let k=e.get(w);k.shadowIntensity=$.intensity,k.shadowBias=$.bias,k.shadowNormalBias=$.normalBias,k.shadowRadius=$.radius,k.shadowMapSize=$.mapSize,n.spotShadow[_]=k,n.spotShadowMap[_]=Z,x++;}_++;}else if(w.isRectAreaLight){let Y=t.get(w);Y.color.copy(z).multiplyScalar(H),Y.halfWidth.set(w.width*.5,0,0),Y.halfHeight.set(0,w.height*.5,0),n.rectArea[m]=Y,m++;}else if(w.isPointLight){let Y=t.get(w);if(Y.color.copy(w.color).multiplyScalar(w.intensity),Y.distance=w.distance,Y.decay=w.decay,w.castShadow){let $=w.shadow,k=e.get(w);k.shadowIntensity=$.intensity,k.shadowBias=$.bias,k.shadowNormalBias=$.normalBias,k.shadowRadius=$.radius,k.shadowMapSize=$.mapSize,k.shadowCameraNear=$.camera.near,k.shadowCameraFar=$.camera.far,n.pointShadow[g]=k,n.pointShadowMap[g]=Z,n.pointShadowMatrix[g]=w.shadow.matrix,S++;}n.point[g]=Y,g++;}else if(w.isHemisphereLight){let Y=t.get(w);Y.skyColor.copy(w.color).multiplyScalar(H),Y.groundColor.copy(w.groundColor).multiplyScalar(H),n.hemi[p]=Y,p++;}}m>0&&(s.has("OES_texture_float_linear")===!0?(n.rectAreaLTC1=ot.LTC_FLOAT_1,n.rectAreaLTC2=ot.LTC_FLOAT_2):(n.rectAreaLTC1=ot.LTC_HALF_1,n.rectAreaLTC2=ot.LTC_HALF_2)),n.ambient[0]=h,n.ambient[1]=u,n.ambient[2]=d;let O=n.hash;(O.directionalLength!==f||O.pointLength!==g||O.spotLength!==_||O.rectAreaLength!==m||O.hemiLength!==p||O.numDirectionalShadows!==T||O.numPointShadows!==S||O.numSpotShadows!==x||O.numSpotMaps!==C||O.numLightProbes!==R)&&(n.directional.length=f,n.spot.length=_,n.rectArea.length=m,n.point.length=g,n.hemi.length=p,n.directionalShadow.length=T,n.directionalShadowMap.length=T,n.pointShadow.length=S,n.pointShadowMap.length=S,n.spotShadow.length=x,n.spotShadowMap.length=x,n.directionalShadowMatrix.length=T,n.pointShadowMatrix.length=S,n.spotLightMatrix.length=x+C-A,n.spotLightMap.length=C,n.numSpotLightShadowsWithMaps=A,n.numLightProbes=R,O.directionalLength=f,O.pointLength=g,O.spotLength=_,O.rectAreaLength=m,O.hemiLength=p,O.numDirectionalShadows=T,O.numPointShadows=S,O.numSpotShadows=x,O.numSpotMaps=C,O.numLightProbes=R,n.version=Bg++);}function c(l,h){let u=0,d=0,f=0,g=0,_=0,m=h.matrixWorldInverse;for(let p=0,T=l.length;p<T;p++){let S=l[p];if(S.isDirectionalLight){let x=n.directional[u];x.direction.setFromMatrixPosition(S.matrixWorld),i.setFromMatrixPosition(S.target.matrixWorld),x.direction.sub(i),x.direction.transformDirection(m),u++;}else if(S.isSpotLight){let x=n.spot[f];x.position.setFromMatrixPosition(S.matrixWorld),x.position.applyMatrix4(m),x.direction.setFromMatrixPosition(S.matrixWorld),i.setFromMatrixPosition(S.target.matrixWorld),x.direction.sub(i),x.direction.transformDirection(m),f++;}else if(S.isRectAreaLight){let x=n.rectArea[g];x.position.setFromMatrixPosition(S.matrixWorld),x.position.applyMatrix4(m),o.identity(),r.copy(S.matrixWorld),r.premultiply(m),o.extractRotation(r),x.halfWidth.set(S.width*.5,0,0),x.halfHeight.set(0,S.height*.5,0),x.halfWidth.applyMatrix4(o),x.halfHeight.applyMatrix4(o),g++;}else if(S.isPointLight){let x=n.point[d];x.position.setFromMatrixPosition(S.matrixWorld),x.position.applyMatrix4(m),d++;}else if(S.isHemisphereLight){let x=n.hemi[_];x.direction.setFromMatrixPosition(S.matrixWorld),x.direction.transformDirection(m),_++;}}}return{setup:a,setupView:c,state:n};}function au(s){let t=new kg(s),e=[],n=[];function i(h){l.camera=h,e.length=0,n.length=0;}function r(h){e.push(h);}function o(h){n.push(h);}function a(){t.setup(e);}function c(h){t.setupView(e,h);}let l={lightsArray:e,shadowsArray:n,camera:null,lights:t,transmissionRenderTarget:{}};return{init:i,state:l,setupLights:a,setupLightsView:c,pushLight:r,pushShadow:o};}function zg(s){let t=new WeakMap();function e(i,r=0){let o=t.get(i),a;return o===void 0?(a=new au(s),t.set(i,[a])):r>=o.length?(a=new au(s),o.push(a)):a=o[r],a;}function n(){t=new WeakMap();}return{get:e,dispose:n};}var Vg=`void main() {
	gl_Position = vec4( position, 1.0 );
...
}`;function Wg(s,t,e){let n=new Ri(),i=new $t(),r=new $t(),o=new Se(),a=new Qr({depthPacking:Th}),c=new to(),l={},h=e.maxTextureSize,u={[qn]:Ye,[Ye]:qn,[In]:In},d=new bn({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new $t()},radius:{value:4}},vertexShader:Vg,fragmentShader:Gg}),f=d.clone();f.defines.HORIZONTAL_PASS=1;let g=new ui();g.setAttribute("position",new tn(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));let _=new Ue(g,d),m=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=Ka;let p=this.type;this.render=function(A,R,O){if(m.enabled===!1||m.autoUpdate===!1&&m.needsUpdate===!1||A.length===0)return;let M=s.getRenderTarget(),b=s.getActiveCubeFace(),w=s.getActiveMipmapLevel(),z=s.state;z.setBlending(Kn),z.buffers.depth.getReversed()?z.buffers.color.setClear(0,0,0,0):z.buffers.color.setClear(1,1,1,1),z.buffers.depth.setTest(!0),z.setScissorTest(!1);let H=p!==Rn&&this.type===Rn,X=p===Rn&&this.type!==Rn;for(let Z=0,Y=A.length;Z<Y;Z++){let $=A[Z],k=$.shadow;if(k===void 0){console.warn("THREE.WebGLShadowMap:",$,"has no shadow.");continue;}if(k.autoUpdate===!1&&k.needsUpdate===!1)continue;i.copy(k.mapSize);let at=k.getFrameExtents();if(i.multiply(at),r.copy(k.mapSize),(i.x>h||i.y>h)&&(i.x>h&&(r.x=Math.floor(h/at.x),i.x=r.x*at.x,k.mapSize.x=r.x),i.y>h&&(r.y=Math.floor(h/at.y),i.y=r.y*at.y,k.mapSize.y=r.y)),k.map===null||H===!0||X===!0){let wt=this.type!==Rn?{minFilter:un,magFilter:un}:{};k.map!==null&&k.map.dispose(),k.map=new Cn(i.x,i.y,wt),k.map.texture.name=$.name+".shadowMap",k.camera.updateProjectionMatrix();}s.setRenderTarget(k.map),s.clear();let dt=k.getViewportCount();for(let wt=0;wt<dt;wt++){let Gt=k.getViewport(wt);o.set(r.x*Gt.x,r.y*Gt.y,r.x*Gt.z,r.y*Gt.w),z.viewport(o),k.updateMatrices($,wt),n=k.getFrustum(),x(R,O,k.camera,$,this.type);}k.isPointLightShadow!==!0&&this.type===Rn&&T(k,O),k.needsUpdate=!1;}p=this.type,m.needsUpdate=!1,s.setRenderTarget(M,b,w);};function T(A,R){let O=t.update(_);d.defines.VSM_SAMPLES!==A.blurSamples&&(d.defines.VSM_SAMPLES=A.blurSamples,f.defines.VSM_SAMPLES=A.blurSamples,d.needsUpdate=!0,f.needsUpdate=!0),A.mapPass===null&&(A.mapPass=new Cn(i.x,i.y)),d.uniforms.shadow_pass.value=A.map.texture,d.uniforms.resolution.value=A.mapSize,d.uniforms.radius.value=A.radius,s.setRenderTarget(A.mapPass),s.clear(),s.renderBufferDirect(R,null,O,d,_,null),f.uniforms.shadow_pass.value=A.mapPass.texture,f.uniforms.resolution.value=A.mapSize,f.uniforms.radius.value=A.radius,s.setRenderTarget(A.map),s.clear(),s.renderBufferDirect(R,null,O,f,_,null);}function S(A,R,O,M){let b=null,w=O.isPointLight===!0?A.customDistanceMaterial:A.customDepthMaterial;if(w!==void 0)b=w;else if(b=O.isPointLight===!0?c:a,s.localClippingEnabled&&R.clipShadows===!0&&Array.isArray(R.clippingPlanes)&&R.clippingPlanes.length!==0||R.displacementMap&&R.displacementScale!==0||R.alphaMap&&R.alphaTest>0||R.map&&R.alphaTest>0||R.alphaToCoverage===!0){let z=b.uuid,H=R.uuid,X=l[z];X===void 0&&(X={},l[z]=X);let Z=X[H];Z===void 0&&(Z=b.clone(),X[H]=Z,R.addEventListener("dispose",C)),b=Z;}if(b.visible=R.visible,b.wireframe=R.wireframe,M===Rn?b.side=R.shadowSide!==null?R.shadowSide:R.side:b.side=R.shadowSide!==null?R.shadowSide:u[R.side],b.alphaMap=R.alphaMap,b.alphaTest=R.alphaToCoverage===!0?.5:R.alphaTest,b.map=R.map,b.clipShadows=R.clipShadows,b.clippingPlanes=R.clippingPlanes,b.clipIntersection=R.clipIntersection,b.displacementMap=R.displacementMap,b.displacementScale=R.displacementScale,b.displacementBias=R.displacementBias,b.wireframeLinewidth=R.wireframeLinewidth,b.linewidth=R.linewidth,O.isPointLight===!0&&b.isMeshDistanceMaterial===!0){let z=s.properties.get(b);z.light=O;}return b;}function x(A,R,O,M,b){if(A.visible===!1)return;if(A.layers.test(R.layers)&&(A.isMesh||A.isLine||A.isPoints)&&(A.castShadow||A.receiveShadow&&b===Rn)&&(!A.frustumCulled||n.intersectsObject(A))){A.modelViewMatrix.multiplyMatrices(O.matrixWorldInverse,A.matrixWorld);let H=t.update(A),X=A.material;if(Array.isArray(X)){let Z=H.groups;for(let Y=0,$=Z.length;Y<$;Y++){let k=Z[Y],at=X[k.materialIndex];if(at&&at.visible){let dt=S(A,at,M,b);A.onBeforeShadow(s,A,R,O,H,dt,k),s.renderBufferDirect(O,null,H,dt,A,k),A.onAfterShadow(s,A,R,O,H,dt,k);}}}else if(X.visible){let Z=S(A,X,M,b);A.onBeforeShadow(s,A,R,O,H,Z,null),s.renderBufferDirect(O,null,H,Z,A,null),A.onAfterShadow(s,A,R,O,H,Z,null);}}let z=A.children;for(let H=0,X=z.length;H<X;H++)x(z[H],R,O,M,b);}function C(A){A.target.removeEventListener("dispose",C);for(let O in l){let M=l[O],b=A.target.uuid;b in M&&(M[b].dispose(),delete M[b]);}}}var Xg={[mo]:go,[_o]:xo,[yo]:bo,[wi]:vo,[go]:mo,[xo]:_o,[bo]:yo,[vo]:wi};function Yg(s,t){function e(){let I=!1,et=new Se(),st=null,pt=new Se(0,0,0,0);return{setMask:function(J){st!==J&&!I&&(s.colorMask(J,J,J,J),st=J);},setLocked:function(J){I=J;},setClear:function(J,q,yt,Bt,de){de===!0&&(J*=Bt,q*=Bt,yt*=Bt),et.set(J,q,yt,Bt),pt.equals(et)===!1&&(s.clearColor(J,q,yt,Bt),pt.copy(et));},reset:function(){I=!1,st=null,pt.set(-1,0,0,0);}};}function n(){let I=!1,et=!1,st=null,pt=null,J=null;return{setReversed:function(q){if(et!==q){let yt=t.get("EXT_clip_control");q?yt.clipControlEXT(yt.LOWER_LEFT_EXT,yt.ZERO_TO_ONE_EXT):yt.clipControlEXT(yt.LOWER_LEFT_EXT,yt.NEGATIVE_ONE_TO_ONE_EXT),et=q;let Bt=J;J=null,this.setClear(Bt);}},getReversed:function(){return et;},setTest:function(q){q?it(s.DEPTH_TEST):Rt(s.DEPTH_TEST);},setMask:function(q){st!==q&&!I&&(s.depthMask(q),st=q);},setFunc:function(q){if(et&&(q=Xg[q]),pt!==q){switch(q){case mo:s.depthFunc(s.NEVER);break;case go:s.depthFunc(s.ALWAYS);break;case _o:s.depthFunc(s.LESS);break;case wi:s.depthFunc(s.LEQUAL);break;case yo:s.depthFunc(s.EQUAL);break;case vo:s.depthFunc(s.GEQUAL);break;case xo:s.depthFunc(s.GREATER);break;case bo:s.depthFunc(s.NOTEQUAL);break;default:s.depthFunc(s.LEQUAL);}pt=q;}},setLocked:function(q){I=q;},setClear:function(q){J!==q&&(et&&(q=1-q),s.clearDepth(q),J=q);},reset:function(){I=!1,st=null,pt=null,J=null,et=!1;}};}function i(){let I=!1,et=null,st=null,pt=null,J=null,q=null,yt=null,Bt=null,de=null;return{setTest:function(re){I||(re?it(s.STENCIL_TEST):Rt(s.STENCIL_TEST));},setMask:function(re){et!==re&&!I&&(s.stencilMask(re),et=re);},setFunc:function(re,Nn,Mn){(st!==re||pt!==Nn||J!==Mn)&&(s.stencilFunc(re,Nn,Mn),st=re,pt=Nn,J=Mn);},setOp:function(re,Nn,Mn){(q!==re||yt!==Nn||Bt!==Mn)&&(s.stencilOp(re,Nn,Mn),q=re,yt=Nn,Bt=Mn);},setLocked:function(re){I=re;},setClear:function(re){de!==re&&(s.clearStencil(re),de=re);},reset:function(){I=!1,et=null,st=null,pt=null,J=null,q=null,yt=null,Bt=null,de=null;}};}let r=new e(),o=new n(),a=new i(),c=new WeakMap(),l=new WeakMap(),h={},u={},d=new WeakMap(),f=[],g=null,_=!1,m=null,p=null,T=null,S=null,x=null,C=null,A=null,R=new Qt(0,0,0),O=0,M=!1,b=null,w=null,z=null,H=null,X=null,Z=s.getParameter(s.MAX_COMBINED_TEXTURE_IMAGE_UNITS),Y=!1,$=0,k=s.getParameter(s.VERSION);k.indexOf("WebGL")!==-1?($=parseFloat(/^WebGL (\d)/.exec(k)[1]),Y=$>=1):k.indexOf("OpenGL ES")!==-1&&($=parseFloat(/^OpenGL ES (\d)/.exec(k)[1]),Y=$>=2);let at=null,dt={},wt=s.getParameter(s.SCISSOR_BOX),Gt=s.getParameter(s.VIEWPORT),me=new Se().fromArray(wt),ce=new Se().fromArray(Gt);function W(I,et,st,pt){let J=new Uint8Array(4),q=s.createTexture();s.bindTexture(I,q),s.texParameteri(I,s.TEXTURE_MIN_FILTER,s.NEAREST),s.texParameteri(I,s.TEXTURE_MAG_FILTER,s.NEAREST);for(let yt=0;yt<st;yt++)I===s.TEXTURE_3D||I===s.TEXTURE_2D_ARRAY?s.texImage3D(et,0,s.RGBA,1,1,pt,0,s.RGBA,s.UNSIGNED_BYTE,J):s.texImage2D(et+yt,0,s.RGBA,1,1,0,s.RGBA,s.UNSIGNED_BYTE,J);return q;}let lt={};lt[s.TEXTURE_2D]=W(s.TEXTURE_2D,s.TEXTURE_2D,1),lt[s.TEXTURE_CUBE_MAP]=W(s.TEXTURE_CUBE_MAP,s.TEXTURE_CUBE_MAP_POSITIVE_X,6),lt[s.TEXTURE_2D_ARRAY]=W(s.TEXTURE_2D_ARRAY,s.TEXTURE_2D_ARRAY,1,1),lt[s.TEXTURE_3D]=W(s.TEXTURE_3D,s.TEXTURE_3D,1,1),r.setClear(0,0,0,1),o.setClear(1),a.setClear(0),it(s.DEPTH_TEST),o.setFunc(wi),ee(!1),Tt($a),it(s.CULL_FACE),ue(Kn);function it(I){h[I]!==!0&&(s.enable(I),h[I]=!0);}function Rt(I){h[I]!==!1&&(s.disable(I),h[I]=!1);}function It(I,et){return u[I]!==et?(s.bindFramebuffer(I,et),u[I]=et,I===s.DRAW_FRAMEBUFFER&&(u[s.FRAMEBUFFER]=et),I===s.FRAMEBUFFER&&(u[s.DRAW_FRAMEBUFFER]=et),!0):!1;}function Ut(I,et){let st=f,pt=!1;if(I){st=d.get(et),st===void 0&&(st=[],d.set(et,st));let J=I.textures;if(st.length!==J.length||st[0]!==s.COLOR_ATTACHMENT0){for(let q=0,yt=J.length;q<yt;q++)st[q]=s.COLOR_ATTACHMENT0+q;st.length=J.length,pt=!0;}}else st[0]!==s.BACK&&(st[0]=s.BACK,pt=!0);pt&&s.drawBuffers(st);}function Te(I){return g!==I?(s.useProgram(I),g=I,!0):!1;}let Kt={[hi]:s.FUNC_ADD,[Kc]:s.FUNC_SUBTRACT,[Jc]:s.FUNC_REVERSE_SUBTRACT};Kt[jc]=s.MIN,Kt[Qc]=s.MAX;let P={[th]:s.ZERO,[eh]:s.ONE,[nh]:s.SRC_COLOR,[Gr]:s.SRC_ALPHA,[lh]:s.SRC_ALPHA_SATURATE,[oh]:s.DST_COLOR,[sh]:s.DST_ALPHA,[ih]:s.ONE_MINUS_SRC_COLOR,[Wr]:s.ONE_MINUS_SRC_ALPHA,[ah]:s.ONE_MINUS_DST_COLOR,[rh]:s.ONE_MINUS_DST_ALPHA,[ch]:s.CONSTANT_COLOR,[hh]:s.ONE_MINUS_CONSTANT_COLOR,[uh]:s.CONSTANT_ALPHA,[dh]:s.ONE_MINUS_CONSTANT_ALPHA};function ue(I,et,st,pt,J,q,yt,Bt,de,re){if(I===Kn){_===!0&&(Rt(s.BLEND),_=!1);return;}if(_===!1&&(it(s.BLEND),_=!0),I!==$c){if(I!==m||re!==M){if((p!==hi||x!==hi)&&(s.blendEquation(s.FUNC_ADD),p=hi,x=hi),re)switch(I){case Ei:s.blendFuncSeparate(s.ONE,s.ONE_MINUS_SRC_ALPHA,s.ONE,s.ONE_MINUS_SRC_ALPHA);break;case Ja:s.blendFunc(s.ONE,s.ONE);break;case ja:s.blendFuncSeparate(s.ZERO,s.ONE_MINUS_SRC_COLOR,s.ZERO,s.ONE);break;case Qa:s.blendFuncSeparate(s.DST_COLOR,s.ONE_MINUS_SRC_ALPHA,s.ZERO,s.ONE);break;default:console.error("THREE.WebGLState: Invalid blending: ",I);break;}else switch(I){case Ei:s.blendFuncSeparate(s.SRC_ALPHA,s.ONE_MINUS_SRC_ALPHA,s.ONE,s.ONE_MINUS_SRC_ALPHA);break;case Ja:s.blendFuncSeparate(s.SRC_ALPHA,s.ONE,s.ONE,s.ONE);break;case ja:console.error("THREE.WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case Qa:console.error("THREE.WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:console.error("THREE.WebGLState: Invalid blending: ",I);break;}T=null,S=null,C=null,A=null,R.set(0,0,0),O=0,m=I,M=re;}return;}J=J||et,q=q||st,yt=yt||pt,(et!==p||J!==x)&&(s.blendEquationSeparate(Kt[et],Kt[J]),p=et,x=J),(st!==T||pt!==S||q!==C||yt!==A)&&(s.blendFuncSeparate(P[st],P[pt],P[q],P[yt]),T=st,S=pt,C=q,A=yt),(Bt.equals(R)===!1||de!==O)&&(s.blendColor(Bt.r,Bt.g,Bt.b,de),R.copy(Bt),O=de),m=I,M=!1;}function At(I,et){I.side===In?Rt(s.CULL_FACE):it(s.CULL_FACE);let st=I.side===Ye;et&&(st=!st),ee(st),I.blending===Ei&&I.transparent===!1?ue(Kn):ue(I.blending,I.blendEquation,I.blendSrc,I.blendDst,I.blendEquationAlpha,I.blendSrcAlpha,I.blendDstAlpha,I.blendColor,I.blendAlpha,I.premultipliedAlpha),o.setFunc(I.depthFunc),o.setTest(I.depthTest),o.setMask(I.depthWrite),r.setMask(I.colorWrite);let pt=I.stencilWrite;a.setTest(pt),pt&&(a.setMask(I.stencilWriteMask),a.setFunc(I.stencilFunc,I.stencilRef,I.stencilFuncMask),a.setOp(I.stencilFail,I.stencilZFail,I.stencilZPass)),mt(I.polygonOffset,I.polygonOffsetFactor,I.polygonOffsetUnits),I.alphaToCoverage===!0?it(s.SAMPLE_ALPHA_TO_COVERAGE):Rt(s.SAMPLE_ALPHA_TO_COVERAGE);}function ee(I){b!==I&&(I?s.frontFace(s.CW):s.frontFace(s.CCW),b=I);}function Tt(I){I!==Yc?(it(s.CULL_FACE),I!==w&&(I===$a?s.cullFace(s.BACK):I===qc?s.cullFace(s.FRONT):s.cullFace(s.FRONT_AND_BACK))):Rt(s.CULL_FACE),w=I;}function ge(I){I!==z&&(Y&&s.lineWidth(I),z=I);}function mt(I,et,st){I?(it(s.POLYGON_OFFSET_FILL),(H!==et||X!==st)&&(s.polygonOffset(et,st),H=et,X=st)):Rt(s.POLYGON_OFFSET_FILL);}function Wt(I){I?it(s.SCISSOR_TEST):Rt(s.SCISSOR_TEST);}function Fe(I){I===void 0&&(I=s.TEXTURE0+Z-1),at!==I&&(s.activeTexture(I),at=I);}function Ee(I,et,st){st===void 0&&(at===null?st=s.TEXTURE0+Z-1:st=at);let pt=dt[st];pt===void 0&&(pt={type:void 0,texture:void 0},dt[st]=pt),(pt.type!==I||pt.texture!==et)&&(at!==st&&(s.activeTexture(st),at=st),s.bindTexture(I,et||lt[I]),pt.type=I,pt.texture=et);}function E(){let I=dt[at];I!==void 0&&I.type!==void 0&&(s.bindTexture(I.type,null),I.type=void 0,I.texture=void 0);}function y(){try{s.compressedTexImage2D(...arguments);}catch(I){console.error("THREE.WebGLState:",I);}}function F(){try{s.compressedTexImage3D(...arguments);}catch(I){console.error("THREE.WebGLState:",I);}}function G(){try{s.texSubImage2D(...arguments);}catch(I){console.error("THREE.WebGLState:",I);}}function K(){try{s.texSubImage3D(...arguments);}catch(I){console.error("THREE.WebGLState:",I);}}function V(){try{s.compressedTexSubImage2D(...arguments);}catch(I){console.error("THREE.WebGLState:",I);}}function St(){try{s.compressedTexSubImage3D(...arguments);}catch(I){console.error("THREE.WebGLState:",I);}}function nt(){try{s.texStorage2D(...arguments);}catch(I){console.error("THREE.WebGLState:",I);}}function xt(){try{s.texStorage3D(...arguments);}catch(I){console.error("THREE.WebGLState:",I);}}function bt(){try{s.texImage2D(...arguments);}catch(I){console.error("THREE.WebGLState:",I);}}function tt(){try{s.texImage3D(...arguments);}catch(I){console.error("THREE.WebGLState:",I);}}function ut(I){me.equals(I)===!1&&(s.scissor(I.x,I.y,I.z,I.w),me.copy(I));}function Dt(I){ce.equals(I)===!1&&(s.viewport(I.x,I.y,I.z,I.w),ce.copy(I));}function Mt(I,et){let st=l.get(et);st===void 0&&(st=new WeakMap(),l.set(et,st));let pt=st.get(I);pt===void 0&&(pt=s.getUniformBlockIndex(et,I.name),st.set(I,pt));}function ct(I,et){let pt=l.get(et).get(I);c.get(et)!==pt&&(s.uniformBlockBinding(et,pt,I.__bindingPointIndex),c.set(et,pt));}function kt(){s.disable(s.BLEND),s.disable(s.CULL_FACE),s.disable(s.DEPTH_TEST),s.disable(s.POLYGON_OFFSET_FILL),s.disable(s.SCISSOR_TEST),s.disable(s.STENCIL_TEST),s.disable(s.SAMPLE_ALPHA_TO_COVERAGE),s.blendEquation(s.FUNC_ADD),s.blendFunc(s.ONE,s.ZERO),s.blendFuncSeparate(s.ONE,s.ZERO,s.ONE,s.ZERO),s.blendColor(0,0,0,0),s.colorMask(!0,!0,!0,!0),s.clearColor(0,0,0,0),s.depthMask(!0),s.depthFunc(s.LESS),o.setReversed(!1),s.clearDepth(1),s.stencilMask(4294967295),s.stencilFunc(s.ALWAYS,0,4294967295),s.stencilOp(s.KEEP,s.KEEP,s.KEEP),s.clearStencil(0),s.cullFace(s.BACK),s.frontFace(s.CCW),s.polygonOffset(0,0),s.activeTexture(s.TEXTURE0),s.bindFramebuffer(s.FRAMEBUFFER,null),s.bindFramebuffer(s.DRAW_FRAMEBUFFER,null),s.bindFramebuffer(s.READ_FRAMEBUFFER,null),s.useProgram(null),s.lineWidth(1),s.scissor(0,0,s.canvas.width,s.canvas.height),s.viewport(0,0,s.canvas.width,s.canvas.height),h={},at=null,dt={},u={},d=new WeakMap(),f=[],g=null,_=!1,m=null,p=null,T=null,S=null,x=null,C=null,A=null,R=new Qt(0,0,0),O=0,M=!1,b=null,w=null,z=null,H=null,X=null,me.set(0,0,s.canvas.width,s.canvas.height),ce.set(0,0,s.canvas.width,s.canvas.height),r.reset(),o.reset(),a.reset();}return{buffers:{color:r,depth:o,stencil:a},enable:it,disable:Rt,bindFramebuffer:It,drawBuffers:Ut,useProgram:Te,setBlending:ue,setMaterial:At,setFlipSided:ee,setCullFace:Tt,setLineWidth:ge,setPolygonOffset:mt,setScissorTest:Wt,activeTexture:Fe,bindTexture:Ee,unbindTexture:E,compressedTexImage2D:y,compressedTexImage3D:F,texImage2D:bt,texImage3D:tt,updateUBOMapping:Mt,uniformBlockBinding:ct,texStorage2D:nt,texStorage3D:xt,texSubImage2D:G,texSubImage3D:K,compressedTexSubImage2D:V,compressedTexSubImage3D:St,scissor:ut,viewport:Dt,reset:kt};}function qg(s,t,e,n,i,r,o){let a=t.has("WEBGL_multisampled_render_to_texture")?t.get("WEBGL_multisampled_render_to_texture"):null,c=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),l=new $t(),h=new WeakMap(),u,d=new WeakMap(),f=!1;try{f=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null;}catch{}function g(E,y){return f?new OffscreenCanvas(E,y):hs("canvas");}function _(E,y,F){let G=1,K=Ee(E);if((K.width>F||K.height>F)&&(G=F/Math.max(K.width,K.height)),G<1)if(typeof HTMLImageElement<"u"&&E instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&E instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&E instanceof ImageBitmap||typeof VideoFrame<"u"&&E instanceof VideoFrame){let V=Math.floor(G*K.width),St=Math.floor(G*K.height);u===void 0&&(u=g(V,St));let nt=y?g(V,St):u;return nt.width=V,nt.height=St,nt.getContext("2d").drawImage(E,0,0,V,St),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+K.width+"x"+K.height+") to ("+V+"x"+St+")."),nt;}else return"data"in E&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+K.width+"x"+K.height+")."),E;return E;}function m(E){return E.generateMipmaps;}function p(E){s.generateMipmap(E);}function T(E){return E.isWebGLCubeRenderTarget?s.TEXTURE_CUBE_MAP:E.isWebGL3DRenderTarget?s.TEXTURE_3D:E.isWebGLArrayRenderTarget||E.isCompressedArrayTexture?s.TEXTURE_2D_ARRAY:s.TEXTURE_2D;}function S(E,y,F,G,K=!1){if(E!==null){if(s[E]!==void 0)return s[E];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+E+"'");}let V=y;if(y===s.RED&&(F===s.FLOAT&&(V=s.R32F),F===s.HALF_FLOAT&&(V=s.R16F),F===s.UNSIGNED_BYTE&&(V=s.R8)),y===s.RED_INTEGER&&(F===s.UNSIGNED_BYTE&&(V=s.R8UI),F===s.UNSIGNED_SHORT&&(V=s.R16UI),F===s.UNSIGNED_INT&&(V=s.R32UI),F===s.BYTE&&(V=s.R8I),F===s.SHORT&&(V=s.R16I),F===s.INT&&(V=s.R32I)),y===s.RG&&(F===s.FLOAT&&(V=s.RG32F),F===s.HALF_FLOAT&&(V=s.RG16F),F===s.UNSIGNED_BYTE&&(V=s.RG8)),y===s.RG_INTEGER&&(F===s.UNSIGNED_BYTE&&(V=s.RG8UI),F===s.UNSIGNED_SHORT&&(V=s.RG16UI),F===s.UNSIGNED_INT&&(V=s.RG32UI),F===s.BYTE&&(V=s.RG8I),F===s.SHORT&&(V=s.RG16I),F===s.INT&&(V=s.RG32I)),y===s.RGB_INTEGER&&(F===s.UNSIGNED_BYTE&&(V=s.RGB8UI),F===s.UNSIGNED_SHORT&&(V=s.RGB16UI),F===s.UNSIGNED_INT&&(V=s.RGB32UI),F===s.BYTE&&(V=s.RGB8I),F===s.SHORT&&(V=s.RGB16I),F===s.INT&&(V=s.RGB32I)),y===s.RGBA_INTEGER&&(F===s.UNSIGNED_BYTE&&(V=s.RGBA8UI),F===s.UNSIGNED_SHORT&&(V=s.RGBA16UI),F===s.UNSIGNED_INT&&(V=s.RGBA32UI),F===s.BYTE&&(V=s.RGBA8I),F===s.SHORT&&(V=s.RGBA16I),F===s.INT&&(V=s.RGBA32I)),y===s.RGB&&F===s.UNSIGNED_INT_5_9_9_9_REV&&(V=s.RGB9_E5),y===s.RGBA){let St=K?Hs:Jt.getTransfer(G);F===s.FLOAT&&(V=s.RGBA32F),F===s.HALF_FLOAT&&(V=s.RGBA16F),F===s.UNSIGNED_BYTE&&(V=St===oe?s.SRGB8_ALPHA8:s.RGBA8),F===s.UNSIGNED_SHORT_4_4_4_4&&(V=s.RGBA4),F===s.UNSIGNED_SHORT_5_5_5_1&&(V=s.RGB5_A1);}return(V===s.R16F||V===s.R32F||V===s.RG16F||V===s.RG32F||V===s.RGBA16F||V===s.RGBA32F)&&t.get("EXT_color_buffer_float"),V;}function x(E,y){let F;return E?y===null||y===mi||y===ys?F=s.DEPTH24_STENCIL8:y===Ln?F=s.DEPTH32F_STENCIL8:y===gs&&(F=s.DEPTH24_STENCIL8,console.warn("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):y===null||y===mi||y===ys?F=s.DEPTH_COMPONENT24:y===Ln?F=s.DEPTH_COMPONENT32F:y===gs&&(F=s.DEPTH_COMPONENT16),F;}function C(E,y){return m(E)===!0||E.isFramebufferTexture&&E.minFilter!==un&&E.minFilter!==Xe?Math.log2(Math.max(y.width,y.height))+1:E.mipmaps!==void 0&&E.mipmaps.length>0?E.mipmaps.length:E.isCompressedTexture&&Array.isArray(E.image)?y.mipmaps.length:1;}function A(E){let y=E.target;y.removeEventListener("dispose",A),O(y),y.isVideoTexture&&h.delete(y);}function R(E){let y=E.target;y.removeEventListener("dispose",R),b(y);}function O(E){let y=n.get(E);if(y.__webglInit===void 0)return;let F=E.source,G=d.get(F);if(G){let K=G[y.__cacheKey];K.usedTimes--,K.usedTimes===0&&M(E),Object.keys(G).length===0&&d.delete(F);}n.remove(E);}function M(E){let y=n.get(E);s.deleteTexture(y.__webglTexture);let F=E.source,G=d.get(F);delete G[y.__cacheKey],o.memory.textures--;}function b(E){let y=n.get(E);if(E.depthTexture&&(E.depthTexture.dispose(),n.remove(E.depthTexture)),E.isWebGLCubeRenderTarget)for(let G=0;G<6;G++){if(Array.isArray(y.__webglFramebuffer[G]))for(let K=0;K<y.__webglFramebuffer[G].length;K++)s.deleteFramebuffer(y.__webglFramebuffer[G][K]);else s.deleteFramebuffer(y.__webglFramebuffer[G]);y.__webglDepthbuffer&&s.deleteRenderbuffer(y.__webglDepthbuffer[G]);}else{if(Array.isArray(y.__webglFramebuffer))for(let G=0;G<y.__webglFramebuffer.length;G++)s.deleteFramebuffer(y.__webglFramebuffer[G]);else s.deleteFramebuffer(y.__webglFramebuffer);if(y.__webglDepthbuffer&&s.deleteRenderbuffer(y.__webglDepthbuffer),y.__webglMultisampledFramebuffer&&s.deleteFramebuffer(y.__webglMultisampledFramebuffer),y.__webglColorRenderbuffer)for(let G=0;G<y.__webglColorRenderbuffer.length;G++)y.__webglColorRenderbuffer[G]&&s.deleteRenderbuffer(y.__webglColorRenderbuffer[G]);y.__webglDepthRenderbuffer&&s.deleteRenderbuffer(y.__webglDepthRenderbuffer);}let F=E.textures;for(let G=0,K=F.length;G<K;G++){let V=n.get(F[G]);V.__webglTexture&&(s.deleteTexture(V.__webglTexture),o.memory.textures--),n.remove(F[G]);}n.remove(E);}let w=0;function z(){w=0;}function H(){let E=w;return E>=i.maxTextures&&console.warn("THREE.WebGLTextures: Trying to use "+E+" texture units while this GPU supports only "+i.maxTextures),w+=1,E;}function X(E){let y=[];return y.push(E.wrapS),y.push(E.wrapT),y.push(E.wrapR||0),y.push(E.magFilter),y.push(E.minFilter),y.push(E.anisotropy),y.push(E.internalFormat),y.push(E.format),y.push(E.type),y.push(E.generateMipmaps),y.push(E.premultiplyAlpha),y.push(E.flipY),y.push(E.unpackAlignment),y.push(E.colorSpace),y.join();}function Z(E,y){let F=n.get(E);if(E.isVideoTexture&&Wt(E),E.isRenderTargetTexture===!1&&E.isExternalTexture!==!0&&E.version>0&&F.__version!==E.version){let G=E.image;if(G===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if(G.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{lt(F,E,y);return;}}else E.isExternalTexture&&(F.__webglTexture=E.sourceTexture?E.sourceTexture:null);e.bindTexture(s.TEXTURE_2D,F.__webglTexture,s.TEXTURE0+y);}function Y(E,y){let F=n.get(E);if(E.isRenderTargetTexture===!1&&E.version>0&&F.__version!==E.version){lt(F,E,y);return;}e.bindTexture(s.TEXTURE_2D_ARRAY,F.__webglTexture,s.TEXTURE0+y);}function $(E,y){let F=n.get(E);if(E.isRenderTargetTexture===!1&&E.version>0&&F.__version!==E.version){lt(F,E,y);return;}e.bindTexture(s.TEXTURE_3D,F.__webglTexture,s.TEXTURE0+y);}function k(E,y){let F=n.get(E);if(E.version>0&&F.__version!==E.version){it(F,E,y);return;}e.bindTexture(s.TEXTURE_CUBE_MAP,F.__webglTexture,s.TEXTURE0+y);}let at={[Xr]:s.REPEAT,[En]:s.CLAMP_TO_EDGE,[Yr]:s.MIRRORED_REPEAT},dt={[un]:s.NEAREST,[Mh]:s.NEAREST_MIPMAP_NEAREST,[er]:s.NEAREST_MIPMAP_LINEAR,[Xe]:s.LINEAR,[To]:s.LINEAR_MIPMAP_NEAREST,[On]:s.LINEAR_MIPMAP_LINEAR},wt={[Ch]:s.NEVER,[Dh]:s.ALWAYS,[Ah]:s.LESS,[cl]:s.LEQUAL,[Ph]:s.EQUAL,[Oh]:s.GEQUAL,[Rh]:s.GREATER,[Ih]:s.NOTEQUAL};function Gt(E,y){if(y.type===Ln&&t.has("OES_texture_float_linear")===!1&&(y.magFilter===Xe||y.magFilter===To||y.magFilter===er||y.magFilter===On||y.minFilter===Xe||y.minFilter===To||y.minFilter===er||y.minFilter===On)&&console.warn("THREE.WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),s.texParameteri(E,s.TEXTURE_WRAP_S,at[y.wrapS]),s.texParameteri(E,s.TEXTURE_WRAP_T,at[y.wrapT]),(E===s.TEXTURE_3D||E===s.TEXTURE_2D_ARRAY)&&s.texParameteri(E,s.TEXTURE_WRAP_R,at[y.wrapR]),s.texParameteri(E,s.TEXTURE_MAG_FILTER,dt[y.magFilter]),s.texParameteri(E,s.TEXTURE_MIN_FILTER,dt[y.minFilter]),y.compareFunction&&(s.texParameteri(E,s.TEXTURE_COMPARE_MODE,s.COMPARE_REF_TO_TEXTURE),s.texParameteri(E,s.TEXTURE_COMPARE_FUNC,wt[y.compareFunction])),t.has("EXT_texture_filter_anisotropic")===!0){if(y.magFilter===un||y.minFilter!==er&&y.minFilter!==On||y.type===Ln&&t.has("OES_texture_float_linear")===!1)return;if(y.anisotropy>1||n.get(y).__currentAnisotropy){let F=t.get("EXT_texture_filter_anisotropic");s.texParameterf(E,F.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(y.anisotropy,i.getMaxAnisotropy())),n.get(y).__currentAnisotropy=y.anisotropy;}}}function me(E,y){let F=!1;E.__webglInit===void 0&&(E.__webglInit=!0,y.addEventListener("dispose",A));let G=y.source,K=d.get(G);K===void 0&&(K={},d.set(G,K));let V=X(y);if(V!==E.__cacheKey){K[V]===void 0&&(K[V]={texture:s.createTexture(),usedTimes:0},o.memory.textures++,F=!0),K[V].usedTimes++;let St=K[E.__cacheKey];St!==void 0&&(K[E.__cacheKey].usedTimes--,St.usedTimes===0&&M(y)),E.__cacheKey=V,E.__webglTexture=K[V].texture;}return F;}function ce(E,y,F){return Math.floor(Math.floor(E/F)/y);}function W(E,y,F,G){let V=E.updateRanges;if(V.length===0)e.texSubImage2D(s.TEXTURE_2D,0,0,0,y.width,y.height,F,G,y.data);else{V.sort((tt,ut)=>tt.start-ut.start);let St=0;for(let tt=1;tt<V.length;tt++){let ut=V[St],Dt=V[tt],Mt=ut.start+ut.count,ct=ce(Dt.start,y.width,4),kt=ce(ut.start,y.width,4);Dt.start<=Mt+1&&ct===kt&&ce(Dt.start+Dt.count-1,y.width,4)===ct?ut.count=Math.max(ut.count,Dt.start+Dt.count-ut.start):(++St,V[St]=Dt);}V.length=St+1;let nt=s.getParameter(s.UNPACK_ROW_LENGTH),xt=s.getParameter(s.UNPACK_SKIP_PIXELS),bt=s.getParameter(s.UNPACK_SKIP_ROWS);s.pixelStorei(s.UNPACK_ROW_LENGTH,y.width);for(let tt=0,ut=V.length;tt<ut;tt++){let Dt=V[tt],Mt=Math.floor(Dt.start/4),ct=Math.ceil(Dt.count/4),kt=Mt%y.width,I=Math.floor(Mt/y.width),et=ct,st=1;s.pixelStorei(s.UNPACK_SKIP_PIXELS,kt),s.pixelStorei(s.UNPACK_SKIP_ROWS,I),e.texSubImage2D(s.TEXTURE_2D,0,kt,I,et,st,F,G,y.data);}E.clearUpdateRanges(),s.pixelStorei(s.UNPACK_ROW_LENGTH,nt),s.pixelStorei(s.UNPACK_SKIP_PIXELS,xt),s.pixelStorei(s.UNPACK_SKIP_ROWS,bt);}}function lt(E,y,F){let G=s.TEXTURE_2D;(y.isDataArrayTexture||y.isCompressedArrayTexture)&&(G=s.TEXTURE_2D_ARRAY),y.isData3DTexture&&(G=s.TEXTURE_3D);let K=me(E,y),V=y.source;e.bindTexture(G,E.__webglTexture,s.TEXTURE0+F);let St=n.get(V);if(V.version!==St.__version||K===!0){e.activeTexture(s.TEXTURE0+F);let nt=Jt.getPrimaries(Jt.workingColorSpace),xt=y.colorSpace===jn?null:Jt.getPrimaries(y.colorSpace),bt=y.colorSpace===jn||nt===xt?s.NONE:s.BROWSER_DEFAULT_WEBGL;s.pixelStorei(s.UNPACK_FLIP_Y_WEBGL,y.flipY),s.pixelStorei(s.UNPACK_PREMULTIPLY_ALPHA_WEBGL,y.premultiplyAlpha),s.pixelStorei(s.UNPACK_ALIGNMENT,y.unpackAlignment),s.pixelStorei(s.UNPACK_COLORSPACE_CONVERSION_WEBGL,bt);let tt=_(y.image,!1,i.maxTextureSize);tt=Fe(y,tt);let ut=r.convert(y.format,y.colorSpace),Dt=r.convert(y.type),Mt=S(y.internalFormat,ut,Dt,y.colorSpace,y.isVideoTexture);Gt(G,y);let ct,kt=y.mipmaps,I=y.isVideoTexture!==!0,et=St.__version===void 0||K===!0,st=V.dataReady,pt=C(y,tt);if(y.isDepthTexture)Mt=x(y.format===vs,y.type),et&&(I?e.texStorage2D(s.TEXTURE_2D,1,Mt,tt.width,tt.height):e.texImage2D(s.TEXTURE_2D,0,Mt,tt.width,tt.height,0,ut,Dt,null));else if(y.isDataTexture){if(kt.length>0){I&&et&&e.texStorage2D(s.TEXTURE_2D,pt,Mt,kt[0].width,kt[0].height);for(let J=0,q=kt.length;J<q;J++)ct=kt[J],I?st&&e.texSubImage2D(s.TEXTURE_2D,J,0,0,ct.width,ct.height,ut,Dt,ct.data):e.texImage2D(s.TEXTURE_2D,J,Mt,ct.width,ct.height,0,ut,Dt,ct.data);y.generateMipmaps=!1;}else I?(et&&e.texStorage2D(s.TEXTURE_2D,pt,Mt,tt.width,tt.height),st&&W(y,tt,ut,Dt)):e.texImage2D(s.TEXTURE_2D,0,Mt,tt.width,tt.height,0,ut,Dt,tt.data);}else if(y.isCompressedTexture){if(y.isCompressedArrayTexture){I&&et&&e.texStorage3D(s.TEXTURE_2D_ARRAY,pt,Mt,kt[0].width,kt[0].height,tt.depth);for(let J=0,q=kt.length;J<q;J++)if(ct=kt[J],y.format!==fn){if(ut!==null){if(I){if(st)if(y.layerUpdates.size>0){let yt=_l(ct.width,ct.height,y.format,y.type);for(let Bt of y.layerUpdates){let de=ct.data.subarray(Bt*yt/ct.data.BYTES_PER_ELEMENT,(Bt+1)*yt/ct.data.BYTES_PER_ELEMENT);e.compressedTexSubImage3D(s.TEXTURE_2D_ARRAY,J,0,0,Bt,ct.width,ct.height,1,ut,de);}y.clearLayerUpdates();}else e.compressedTexSubImage3D(s.TEXTURE_2D_ARRAY,J,0,0,0,ct.width,ct.height,tt.depth,ut,ct.data);}else e.compressedTexImage3D(s.TEXTURE_2D_ARRAY,J,Mt,ct.width,ct.height,tt.depth,0,ct.data,0,0);}else console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");}else I?st&&e.texSubImage3D(s.TEXTURE_2D_ARRAY,J,0,0,0,ct.width,ct.height,tt.depth,ut,Dt,ct.data):e.texImage3D(s.TEXTURE_2D_ARRAY,J,Mt,ct.width,ct.height,tt.depth,0,ut,Dt,ct.data);}else{I&&et&&e.texStorage2D(s.TEXTURE_2D,pt,Mt,kt[0].width,kt[0].height);for(let J=0,q=kt.length;J<q;J++)ct=kt[J],y.format!==fn?ut!==null?I?st&&e.compressedTexSubImage2D(s.TEXTURE_2D,J,0,0,ct.width,ct.height,ut,ct.data):e.compressedTexImage2D(s.TEXTURE_2D,J,Mt,ct.width,ct.height,0,ct.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):I?st&&e.texSubImage2D(s.TEXTURE_2D,J,0,0,ct.width,ct.height,ut,Dt,ct.data):e.texImage2D(s.TEXTURE_2D,J,Mt,ct.width,ct.height,0,ut,Dt,ct.data);}}else if(y.isDataArrayTexture){if(I){if(et&&e.texStorage3D(s.TEXTURE_2D_ARRAY,pt,Mt,tt.width,tt.height,tt.depth),st)if(y.layerUpdates.size>0){let J=_l(tt.width,tt.height,y.format,y.type);for(let q of y.layerUpdates){let yt=tt.data.subarray(q*J/tt.data.BYTES_PER_ELEMENT,(q+1)*J/tt.data.BYTES_PER_ELEMENT);e.texSubImage3D(s.TEXTURE_2D_ARRAY,0,0,0,q,tt.width,tt.height,1,ut,Dt,yt);}y.clearLayerUpdates();}else e.texSubImage3D(s.TEXTURE_2D_ARRAY,0,0,0,0,tt.width,tt.height,tt.depth,ut,Dt,tt.data);}else e.texImage3D(s.TEXTURE_2D_ARRAY,0,Mt,tt.width,tt.height,tt.depth,0,ut,Dt,tt.data);}else if(y.isData3DTexture)I?(et&&e.texStorage3D(s.TEXTURE_3D,pt,Mt,tt.width,tt.height,tt.depth),st&&e.texSubImage3D(s.TEXTURE_3D,0,0,0,0,tt.width,tt.height,tt.depth,ut,Dt,tt.data)):e.texImage3D(s.TEXTURE_3D,0,Mt,tt.width,tt.height,tt.depth,0,ut,Dt,tt.data);else if(y.isFramebufferTexture){if(et)if(I)e.texStorage2D(s.TEXTURE_2D,pt,Mt,tt.width,tt.height);else{let J=tt.width,q=tt.height;for(let yt=0;yt<pt;yt++)e.texImage2D(s.TEXTURE_2D,yt,Mt,J,q,0,ut,Dt,null),J>>=1,q>>=1;}}else if(kt.length>0){if(I&&et){let J=Ee(kt[0]);e.texStorage2D(s.TEXTURE_2D,pt,Mt,J.width,J.height);}for(let J=0,q=kt.length;J<q;J++)ct=kt[J],I?st&&e.texSubImage2D(s.TEXTURE_2D,J,0,0,ut,Dt,ct):e.texImage2D(s.TEXTURE_2D,J,Mt,ut,Dt,ct);y.generateMipmaps=!1;}else if(I){if(et){let J=Ee(tt);e.texStorage2D(s.TEXTURE_2D,pt,Mt,J.width,J.height);}st&&e.texSubImage2D(s.TEXTURE_2D,0,0,0,ut,Dt,tt);}else e.texImage2D(s.TEXTURE_2D,0,Mt,ut,Dt,tt);m(y)&&p(G),St.__version=V.version,y.onUpdate&&y.onUpdate(y);}E.__version=y.version;}function it(E,y,F){if(y.image.length!==6)return;let G=me(E,y),K=y.source;e.bindTexture(s.TEXTURE_CUBE_MAP,E.__webglTexture,s.TEXTURE0+F);let V=n.get(K);if(K.version!==V.__version||G===!0){e.activeTexture(s.TEXTURE0+F);let St=Jt.getPrimaries(Jt.workingColorSpace),nt=y.colorSpace===jn?null:Jt.getPrimaries(y.colorSpace),xt=y.colorSpace===jn||St===nt?s.NONE:s.BROWSER_DEFAULT_WEBGL;s.pixelStorei(s.UNPACK_FLIP_Y_WEBGL,y.flipY),s.pixelStorei(s.UNPACK_PREMULTIPLY_ALPHA_WEBGL,y.premultiplyAlpha),s.pixelStorei(s.UNPACK_ALIGNMENT,y.unpackAlignment),s.pixelStorei(s.UNPACK_COLORSPACE_CONVERSION_WEBGL,xt);let bt=y.isCompressedTexture||y.image[0].isCompressedTexture,tt=y.image[0]&&y.image[0].isDataTexture,ut=[];for(let q=0;q<6;q++)!bt&&!tt?ut[q]=_(y.image[q],!0,i.maxCubemapSize):ut[q]=tt?y.image[q].image:y.image[q],ut[q]=Fe(y,ut[q]);let Dt=ut[0],Mt=r.convert(y.format,y.colorSpace),ct=r.convert(y.type),kt=S(y.internalFormat,Mt,ct,y.colorSpace),I=y.isVideoTexture!==!0,et=V.__version===void 0||G===!0,st=K.dataReady,pt=C(y,Dt);Gt(s.TEXTURE_CUBE_MAP,y);let J;if(bt){I&&et&&e.texStorage2D(s.TEXTURE_CUBE_MAP,pt,kt,Dt.width,Dt.height);for(let q=0;q<6;q++){J=ut[q].mipmaps;for(let yt=0;yt<J.length;yt++){let Bt=J[yt];y.format!==fn?Mt!==null?I?st&&e.compressedTexSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+q,yt,0,0,Bt.width,Bt.height,Mt,Bt.data):e.compressedTexImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+q,yt,kt,Bt.width,Bt.height,0,Bt.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):I?st&&e.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+q,yt,0,0,Bt.width,Bt.height,Mt,ct,Bt.data):e.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+q,yt,kt,Bt.width,Bt.height,0,Mt,ct,Bt.data);}}}else{if(J=y.mipmaps,I&&et){J.length>0&&pt++;let q=Ee(ut[0]);e.texStorage2D(s.TEXTURE_CUBE_MAP,pt,kt,q.width,q.height);}for(let q=0;q<6;q++)if(tt){I?st&&e.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+q,0,0,0,ut[q].width,ut[q].height,Mt,ct,ut[q].data):e.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+q,0,kt,ut[q].width,ut[q].height,0,Mt,ct,ut[q].data);for(let yt=0;yt<J.length;yt++){let de=J[yt].image[q].image;I?st&&e.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+q,yt+1,0,0,de.width,de.height,Mt,ct,de.data):e.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+q,yt+1,kt,de.width,de.height,0,Mt,ct,de.data);}}else{I?st&&e.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+q,0,0,0,Mt,ct,ut[q]):e.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+q,0,kt,Mt,ct,ut[q]);for(let yt=0;yt<J.length;yt++){let Bt=J[yt];I?st&&e.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+q,yt+1,0,0,Mt,ct,Bt.image[q]):e.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+q,yt+1,kt,Mt,ct,Bt.image[q]);}}}m(y)&&p(s.TEXTURE_CUBE_MAP),V.__version=K.version,y.onUpdate&&y.onUpdate(y);}E.__version=y.version;}function Rt(E,y,F,G,K,V){let St=r.convert(F.format,F.colorSpace),nt=r.convert(F.type),xt=S(F.internalFormat,St,nt,F.colorSpace),bt=n.get(y),tt=n.get(F);if(tt.__renderTarget=y,!bt.__hasExternalTextures){let ut=Math.max(1,y.width>>V),Dt=Math.max(1,y.height>>V);K===s.TEXTURE_3D||K===s.TEXTURE_2D_ARRAY?e.texImage3D(K,V,xt,ut,Dt,y.depth,0,St,nt,null):e.texImage2D(K,V,xt,ut,Dt,0,St,nt,null);}e.bindFramebuffer(s.FRAMEBUFFER,E),mt(y)?a.framebufferTexture2DMultisampleEXT(s.FRAMEBUFFER,G,K,tt.__webglTexture,0,ge(y)):(K===s.TEXTURE_2D||K>=s.TEXTURE_CUBE_MAP_POSITIVE_X&&K<=s.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&s.framebufferTexture2D(s.FRAMEBUFFER,G,K,tt.__webglTexture,V),e.bindFramebuffer(s.FRAMEBUFFER,null);}function It(E,y,F){if(s.bindRenderbuffer(s.RENDERBUFFER,E),y.depthBuffer){let G=y.depthTexture,K=G&&G.isDepthTexture?G.type:null,V=x(y.stencilBuffer,K),St=y.stencilBuffer?s.DEPTH_STENCIL_ATTACHMENT:s.DEPTH_ATTACHMENT,nt=ge(y);mt(y)?a.renderbufferStorageMultisampleEXT(s.RENDERBUFFER,nt,V,y.width,y.height):F?s.renderbufferStorageMultisample(s.RENDERBUFFER,nt,V,y.width,y.height):s.renderbufferStorage(s.RENDERBUFFER,V,y.width,y.height),s.framebufferRenderbuffer(s.FRAMEBUFFER,St,s.RENDERBUFFER,E);}else{let G=y.textures;for(let K=0;K<G.length;K++){let V=G[K],St=r.convert(V.format,V.colorSpace),nt=r.convert(V.type),xt=S(V.internalFormat,St,nt,V.colorSpace),bt=ge(y);F&&mt(y)===!1?s.renderbufferStorageMultisample(s.RENDERBUFFER,bt,xt,y.width,y.height):mt(y)?a.renderbufferStorageMultisampleEXT(s.RENDERBUFFER,bt,xt,y.width,y.height):s.renderbufferStorage(s.RENDERBUFFER,xt,y.width,y.height);}}s.bindRenderbuffer(s.RENDERBUFFER,null);}function Ut(E,y){if(y&&y.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(e.bindFramebuffer(s.FRAMEBUFFER,E),!(y.depthTexture&&y.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");let G=n.get(y.depthTexture);G.__renderTarget=y,(!G.__webglTexture||y.depthTexture.image.width!==y.width||y.depthTexture.image.height!==y.height)&&(y.depthTexture.image.width=y.width,y.depthTexture.image.height=y.height,y.depthTexture.needsUpdate=!0),Z(y.depthTexture,0);let K=G.__webglTexture,V=ge(y);if(y.depthTexture.format===ls)mt(y)?a.framebufferTexture2DMultisampleEXT(s.FRAMEBUFFER,s.DEPTH_ATTACHMENT,s.TEXTURE_2D,K,0,V):s.framebufferTexture2D(s.FRAMEBUFFER,s.DEPTH_ATTACHMENT,s.TEXTURE_2D,K,0);else if(y.depthTexture.format===vs)mt(y)?a.framebufferTexture2DMultisampleEXT(s.FRAMEBUFFER,s.DEPTH_STENCIL_ATTACHMENT,s.TEXTURE_2D,K,0,V):s.framebufferTexture2D(s.FRAMEBUFFER,s.DEPTH_STENCIL_ATTACHMENT,s.TEXTURE_2D,K,0);else throw new Error("Unknown depthTexture format");}function Te(E){let y=n.get(E),F=E.isWebGLCubeRenderTarget===!0;if(y.__boundDepthTexture!==E.depthTexture){let G=E.depthTexture;if(y.__depthDisposeCallback&&y.__depthDisposeCallback(),G){let K=()=>{delete y.__boundDepthTexture,delete y.__depthDisposeCallback,G.removeEventListener("dispose",K);};G.addEventListener("dispose",K),y.__depthDisposeCallback=K;}y.__boundDepthTexture=G;}if(E.depthTexture&&!y.__autoAllocateDepthBuffer){if(F)throw new Error("target.depthTexture not supported in Cube render targets");let G=E.texture.mipmaps;G&&G.length>0?Ut(y.__webglFramebuffer[0],E):Ut(y.__webglFramebuffer,E);}else if(F){y.__webglDepthbuffer=[];for(let G=0;G<6;G++)if(e.bindFramebuffer(s.FRAMEBUFFER,y.__webglFramebuffer[G]),y.__webglDepthbuffer[G]===void 0)y.__webglDepthbuffer[G]=s.createRenderbuffer(),It(y.__webglDepthbuffer[G],E,!1);else{let K=E.stencilBuffer?s.DEPTH_STENCIL_ATTACHMENT:s.DEPTH_ATTACHMENT,V=y.__webglDepthbuffer[G];s.bindRenderbuffer(s.RENDERBUFFER,V),s.framebufferRenderbuffer(s.FRAMEBUFFER,K,s.RENDERBUFFER,V);}}else{let G=E.texture.mipmaps;if(G&&G.length>0?e.bindFramebuffer(s.FRAMEBUFFER,y.__webglFramebuffer[0]):e.bindFramebuffer(s.FRAMEBUFFER,y.__webglFramebuffer),y.__webglDepthbuffer===void 0)y.__webglDepthbuffer=s.createRenderbuffer(),It(y.__webglDepthbuffer,E,!1);else{let K=E.stencilBuffer?s.DEPTH_STENCIL_ATTACHMENT:s.DEPTH_ATTACHMENT,V=y.__webglDepthbuffer;s.bindRenderbuffer(s.RENDERBUFFER,V),s.framebufferRenderbuffer(s.FRAMEBUFFER,K,s.RENDERBUFFER,V);}}e.bindFramebuffer(s.FRAMEBUFFER,null);}function Kt(E,y,F){let G=n.get(E);y!==void 0&&Rt(G.__webglFramebuffer,E,E.texture,s.COLOR_ATTACHMENT0,s.TEXTURE_2D,0),F!==void 0&&Te(E);}function P(E){let y=E.texture,F=n.get(E),G=n.get(y);E.addEventListener("dispose",R);let K=E.textures,V=E.isWebGLCubeRenderTarget===!0,St=K.length>1;if(St||(G.__webglTexture===void 0&&(G.__webglTexture=s.createTexture()),G.__version=y.version,o.memory.textures++),V){F.__webglFramebuffer=[];for(let nt=0;nt<6;nt++)if(y.mipmaps&&y.mipmaps.length>0){F.__webglFramebuffer[nt]=[];for(let xt=0;xt<y.mipmaps.length;xt++)F.__webglFramebuffer[nt][xt]=s.createFramebuffer();}else F.__webglFramebuffer[nt]=s.createFramebuffer();}else{if(y.mipmaps&&y.mipmaps.length>0){F.__webglFramebuffer=[];for(let nt=0;nt<y.mipmaps.length;nt++)F.__webglFramebuffer[nt]=s.createFramebuffer();}else F.__webglFramebuffer=s.createFramebuffer();if(St)for(let nt=0,xt=K.length;nt<xt;nt++){let bt=n.get(K[nt]);bt.__webglTexture===void 0&&(bt.__webglTexture=s.createTexture(),o.memory.textures++);}if(E.samples>0&&mt(E)===!1){F.__webglMultisampledFramebuffer=s.createFramebuffer(),F.__webglColorRenderbuffer=[],e.bindFramebuffer(s.FRAMEBUFFER,F.__webglMultisampledFramebuffer);for(let nt=0;nt<K.length;nt++){let xt=K[nt];F.__webglColorRenderbuffer[nt]=s.createRenderbuffer(),s.bindRenderbuffer(s.RENDERBUFFER,F.__webglColorRenderbuffer[nt]);let bt=r.convert(xt.format,xt.colorSpace),tt=r.convert(xt.type),ut=S(xt.internalFormat,bt,tt,xt.colorSpace,E.isXRRenderTarget===!0),Dt=ge(E);s.renderbufferStorageMultisample(s.RENDERBUFFER,Dt,ut,E.width,E.height),s.framebufferRenderbuffer(s.FRAMEBUFFER,s.COLOR_ATTACHMENT0+nt,s.RENDERBUFFER,F.__webglColorRenderbuffer[nt]);}s.bindRenderbuffer(s.RENDERBUFFER,null),E.depthBuffer&&(F.__webglDepthRenderbuffer=s.createRenderbuffer(),It(F.__webglDepthRenderbuffer,E,!0)),e.bindFramebuffer(s.FRAMEBUFFER,null);}}if(V){e.bindTexture(s.TEXTURE_CUBE_MAP,G.__webglTexture),Gt(s.TEXTURE_CUBE_MAP,y);for(let nt=0;nt<6;nt++)if(y.mipmaps&&y.mipmaps.length>0)for(let xt=0;xt<y.mipmaps.length;xt++)Rt(F.__webglFramebuffer[nt][xt],E,y,s.COLOR_ATTACHMENT0,s.TEXTURE_CUBE_MAP_POSITIVE_X+nt,xt);else Rt(F.__webglFramebuffer[nt],E,y,s.COLOR_ATTACHMENT0,s.TEXTURE_CUBE_MAP_POSITIVE_X+nt,0);m(y)&&p(s.TEXTURE_CUBE_MAP),e.unbindTexture();}else if(St){for(let nt=0,xt=K.length;nt<xt;nt++){let bt=K[nt],tt=n.get(bt),ut=s.TEXTURE_2D;(E.isWebGL3DRenderTarget||E.isWebGLArrayRenderTarget)&&(ut=E.isWebGL3DRenderTarget?s.TEXTURE_3D:s.TEXTURE_2D_ARRAY),e.bindTexture(ut,tt.__webglTexture),Gt(ut,bt),Rt(F.__webglFramebuffer,E,bt,s.COLOR_ATTACHMENT0+nt,ut,0),m(bt)&&p(ut);}e.unbindTexture();}else{let nt=s.TEXTURE_2D;if((E.isWebGL3DRenderTarget||E.isWebGLArrayRenderTarget)&&(nt=E.isWebGL3DRenderTarget?s.TEXTURE_3D:s.TEXTURE_2D_ARRAY),e.bindTexture(nt,G.__webglTexture),Gt(nt,y),y.mipmaps&&y.mipmaps.length>0)for(let xt=0;xt<y.mipmaps.length;xt++)Rt(F.__webglFramebuffer[xt],E,y,s.COLOR_ATTACHMENT0,nt,xt);else Rt(F.__webglFramebuffer,E,y,s.COLOR_ATTACHMENT0,nt,0);m(y)&&p(nt),e.unbindTexture();}E.depthBuffer&&Te(E);}function ue(E){let y=E.textures;for(let F=0,G=y.length;F<G;F++){let K=y[F];if(m(K)){let V=T(E),St=n.get(K).__webglTexture;e.bindTexture(V,St),p(V),e.unbindTexture();}}}let At=[],ee=[];function Tt(E){if(E.samples>0){if(mt(E)===!1){let y=E.textures,F=E.width,G=E.height,K=s.COLOR_BUFFER_BIT,V=E.stencilBuffer?s.DEPTH_STENCIL_ATTACHMENT:s.DEPTH_ATTACHMENT,St=n.get(E),nt=y.length>1;if(nt)for(let bt=0;bt<y.length;bt++)e.bindFramebuffer(s.FRAMEBUFFER,St.__webglMultisampledFramebuffer),s.framebufferRenderbuffer(s.FRAMEBUFFER,s.COLOR_ATTACHMENT0+bt,s.RENDERBUFFER,null),e.bindFramebuffer(s.FRAMEBUFFER,St.__webglFramebuffer),s.framebufferTexture2D(s.DRAW_FRAMEBUFFER,s.COLOR_ATTACHMENT0+bt,s.TEXTURE_2D,null,0);e.bindFramebuffer(s.READ_FRAMEBUFFER,St.__webglMultisampledFramebuffer);let xt=E.texture.mipmaps;xt&&xt.length>0?e.bindFramebuffer(s.DRAW_FRAMEBUFFER,St.__webglFramebuffer[0]):e.bindFramebuffer(s.DRAW_FRAMEBUFFER,St.__webglFramebuffer);for(let bt=0;bt<y.length;bt++){if(E.resolveDepthBuffer&&(E.depthBuffer&&(K|=s.DEPTH_BUFFER_BIT),E.stencilBuffer&&E.resolveStencilBuffer&&(K|=s.STENCIL_BUFFER_BIT)),nt){s.framebufferRenderbuffer(s.READ_FRAMEBUFFER,s.COLOR_ATTACHMENT0,s.RENDERBUFFER,St.__webglColorRenderbuffer[bt]);let tt=n.get(y[bt]).__webglTexture;s.framebufferTexture2D(s.DRAW_FRAMEBUFFER,s.COLOR_ATTACHMENT0,s.TEXTURE_2D,tt,0);}s.blitFramebuffer(0,0,F,G,0,0,F,G,K,s.NEAREST),c===!0&&(At.length=0,ee.length=0,At.push(s.COLOR_ATTACHMENT0+bt),E.depthBuffer&&E.resolveDepthBuffer===!1&&(At.push(V),ee.push(V),s.invalidateFramebuffer(s.DRAW_FRAMEBUFFER,ee)),s.invalidateFramebuffer(s.READ_FRAMEBUFFER,At));}if(e.bindFramebuffer(s.READ_FRAMEBUFFER,null),e.bindFramebuffer(s.DRAW_FRAMEBUFFER,null),nt)for(let bt=0;bt<y.length;bt++){e.bindFramebuffer(s.FRAMEBUFFER,St.__webglMultisampledFramebuffer),s.framebufferRenderbuffer(s.FRAMEBUFFER,s.COLOR_ATTACHMENT0+bt,s.RENDERBUFFER,St.__webglColorRenderbuffer[bt]);let tt=n.get(y[bt]).__webglTexture;e.bindFramebuffer(s.FRAMEBUFFER,St.__webglFramebuffer),s.framebufferTexture2D(s.DRAW_FRAMEBUFFER,s.COLOR_ATTACHMENT0+bt,s.TEXTURE_2D,tt,0);}e.bindFramebuffer(s.DRAW_FRAMEBUFFER,St.__webglMultisampledFramebuffer);}else if(E.depthBuffer&&E.resolveDepthBuffer===!1&&c){let y=E.stencilBuffer?s.DEPTH_STENCIL_ATTACHMENT:s.DEPTH_ATTACHMENT;s.invalidateFramebuffer(s.DRAW_FRAMEBUFFER,[y]);}}}function ge(E){return Math.min(i.maxSamples,E.samples);}function mt(E){let y=n.get(E);return E.samples>0&&t.has("WEBGL_multisampled_render_to_texture")===!0&&y.__useRenderToTexture!==!1;}function Wt(E){let y=o.render.frame;h.get(E)!==y&&(h.set(E,y),E.update());}function Fe(E,y){let F=E.colorSpace,G=E.format,K=E.type;return E.isCompressedTexture===!0||E.isVideoTexture===!0||F!==Ci&&F!==jn&&(Jt.getTransfer(F)===oe?(G!==fn||K!==Dn)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture color space:",F)),y;}function Ee(E){return typeof HTMLImageElement<"u"&&E instanceof HTMLImageElement?(l.width=E.naturalWidth||E.width,l.height=E.naturalHeight||E.height):typeof VideoFrame<"u"&&E instanceof VideoFrame?(l.width=E.displayWidth,l.height=E.displayHeight):(l.width=E.width,l.height=E.height),l;}this.allocateTextureUnit=H,this.resetTextureUnits=z,this.setTexture2D=Z,this.setTexture2DArray=Y,this.setTexture3D=$,this.setTextureCube=k,this.rebindTextures=Kt,this.setupRenderTarget=P,this.updateRenderTargetMipmap=ue,this.updateMultisampleRenderTarget=Tt,this.setupDepthRenderbuffer=Te,this.setupFrameBufferTexture=Rt,this.useMultisampledRTT=mt;}function Zg(s,t){function e(n,i=jn){let r,o=Jt.getTransfer(i);if(n===Dn)return s.UNSIGNED_BYTE;if(n===wo)return s.UNSIGNED_SHORT_4_4_4_4;if(n===Co)return s.UNSIGNED_SHORT_5_5_5_1;if(n===il)return s.UNSIGNED_INT_5_9_9_9_REV;if(n===el)return s.BYTE;if(n===nl)return s.SHORT;if(n===gs)return s.UNSIGNED_SHORT;if(n===Eo)return s.INT;if(n===mi)return s.UNSIGNED_INT;if(n===Ln)return s.FLOAT;if(n===_s)return s.HALF_FLOAT;if(n===sl)return s.ALPHA;if(n===rl)return s.RGB;if(n===fn)return s.RGBA;if(n===ls)return s.DEPTH_COMPONENT;if(n===vs)return s.DEPTH_STENCIL;if(n===ol)return s.RED;if(n===Ao)return s.RED_INTEGER;if(n===al)return s.RG;if(n===Po)return s.RG_INTEGER;if(n===Ro)return s.RGBA_INTEGER;if(n===nr||n===ir||n===sr||n===rr)if(o===oe){if(r=t.get("WEBGL_compressed_texture_s3tc_srgb"),r!==null){if(n===nr)return r.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(n===ir)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(n===sr)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(n===rr)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT;}else return null;}else if(r=t.get("WEBGL_compressed_texture_s3tc"),r!==null){if(n===nr)return r.COMPRESSED_RGB_S3TC_DXT1_EXT;if(n===ir)return r.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(n===sr)return r.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(n===rr)return r.COMPRESSED_RGBA_S3TC_DXT5_EXT;}else return null;if(n===Io||n===Oo||n===Do||n===Lo)if(r=t.get("WEBGL_compressed_texture_pvrtc"),r!==null){if(n===Io)return r.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(n===Oo)return r.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(n===Do)return r.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(n===Lo)return r.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG;}else return null;if(n===Fo||n===No||n===Uo)if(r=t.get("WEBGL_compressed_texture_etc"),r!==null){if(n===Fo||n===No)return o===oe?r.COMPRESSED_SRGB8_ETC2:r.COMPRESSED_RGB8_ETC2;if(n===Uo)return o===oe?r.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:r.COMPRESSED_RGBA8_ETC2_EAC;}else return null;if(n===Bo||n===Ho||n===ko||n===zo||n===Vo||n===Go||n===Wo||n===Xo||n===Yo||n===qo||n===Zo||n===$o||n===Ko||n===Jo)if(r=t.get("WEBGL_compressed_texture_astc"),r!==null){if(n===Bo)return o===oe?r.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:r.COMPRESSED_RGBA_ASTC_4x4_KHR;if(n===Ho)return o===oe?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:r.COMPRESSED_RGBA_ASTC_5x4_KHR;if(n===ko)return o===oe?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:r.COMPRESSED_RGBA_ASTC_5x5_KHR;if(n===zo)return o===oe?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:r.COMPRESSED_RGBA_ASTC_6x5_KHR;if(n===Vo)return o===oe?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:r.COMPRESSED_RGBA_ASTC_6x6_KHR;if(n===Go)return o===oe?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:r.COMPRESSED_RGBA_ASTC_8x5_KHR;if(n===Wo)return o===oe?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:r.COMPRESSED_RGBA_ASTC_8x6_KHR;if(n===Xo)return o===oe?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:r.COMPRESSED_RGBA_ASTC_8x8_KHR;if(n===Yo)return o===oe?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:r.COMPRESSED_RGBA_ASTC_10x5_KHR;if(n===qo)return o===oe?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:r.COMPRESSED_RGBA_ASTC_10x6_KHR;if(n===Zo)return o===oe?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:r.COMPRESSED_RGBA_ASTC_10x8_KHR;if(n===$o)return o===oe?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:r.COMPRESSED_RGBA_ASTC_10x10_KHR;if(n===Ko)return o===oe?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:r.COMPRESSED_RGBA_ASTC_12x10_KHR;if(n===Jo)return o===oe?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:r.COMPRESSED_RGBA_ASTC_12x12_KHR;}else return null;if(n===or||n===jo||n===Qo)if(r=t.get("EXT_texture_compression_bptc"),r!==null){if(n===or)return o===oe?r.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:r.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(n===jo)return r.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(n===Qo)return r.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT;}else return null;if(n===ll||n===ta||n===ea||n===na)if(r=t.get("EXT_texture_compression_rgtc"),r!==null){if(n===or)return r.COMPRESSED_RED_RGTC1_EXT;if(n===ta)return r.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(n===ea)return r.COMPRESSED_RED_GREEN_RGTC2_EXT;if(n===na)return r.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT;}else return null;return n===ys?s.UNSIGNED_INT_24_8:s[n]!==void 0?s[n]:null;}return{convert:e};}var aa=class extends sn{constructor(t=null){super(),this.sourceTexture=t,this.isExternalTexture=!0;}},$g=`
void main() {
...
}`],changeDetection:0});};var i_=(s,t)=>t.id;function s_(s,t){if(s&1&&(rt(0,"div",2),Re(1),gt()),s&2){let e=t.$implicit,n=vt();Ce("prevent",n.isPrevent(e)),Et(),fr(e.name);}}var pa=class s{labels=we([]);static MIN_FONT=8;static MAX_FONT=120;static SCALE_PROBE_WORLD_UNITS=1e3;static EM_PER_CHARACTER=.75;rendererService=pe(pn);ngZone=pe(zi);el=pe(Vi);unregisterFrameCb=null;cachedLabelEls=[];constructor(){ln(()=>{this.labels(),Promise.resolve().then(()=>this.refreshLabelCache());});}ngOnInit(){this.ngZone.runOutsideAngular(()=>{this.unregisterFrameCb=this.rendererService.addFrameCallback(()=>{this.updateLabelPositions();});});}ngOnDestroy(){this.unregisterFrameCb?.(),this.cachedLabelEls=[];}isPrevent(t){return t.rotationDeg<=0;}refreshLabelCache(){let t=this.el.nativeElement;this.cachedLabelEls=Array.from(t.querySelectorAll(".tsne-cluster-label")),this.updateLabelPositions();}updateLabelPositions(){let t=this.labels(),e=this.cachedLabelEls;if(e.length===0)return;let n=this.getWorldToScreenScale();if(n===null)return;let i=window.innerWidth,r=window.innerHeight,{MIN_FONT:o,MAX_FONT:a,EM_PER_CHARACTER:c}=s;for(let l=0;l<e.length;l++){let h=t[l],u=e[l];if(!h)continue;let d=this.rendererService.worldToScreen(h.worldX,h.worldY);if(!d||d.x<0||d.x>i||d.y<0||d.y>r){u.style.opacity="0";continue;}let f=Math.max(1,h.name.length),g=Math.min(a,Math.max(o,h.worldWidth/(f*c)*n));u.style.setProperty("--label-font-size",`${g}px`),u.style.transform=`translate(-50%, -50%) translate(${d.x}px, ${d.y}px) rotate(${-h.rotationDeg*2}deg)`,u.style.opacity="1";}}getWorldToScreenScale(){let t=s.SCALE_PROBE_WORLD_UNITS,e=this.rendererService.worldToScreen(0,0),n=this.rendererService.worldToScreen(t,0);return!e||!n?null:Math.abs(n.x-e.x)/t;}static ɵfac=function(e){return new(e||s)();};static ɵcmp=an({type:s,selectors:[["app-tsne-clusters-overlay"]],inputs:{labels:[1,"labels"]},decls:3,vars:0,consts:[["aria-hidden","true",1,"tsne-cluster-labels-container"],[1,"tsne-cluster-label",3,"prevent"],[1,"tsne-cluster-label"]],template:function(e,n){e&1&&(rt(0,"div",0),Wi(1,s_,2,3,"div",1,i_),gt()),e&2&&(Et(),Xi(n.labels()));},styles:[`
...
.tsne-cluster-label.prevent[_ngcontent-%COMP%] {
  color: #B50F0F;
}`],changeDetection:0});};var r_=["anchor"];function o_(s,t){s&1&&(rt(0,"span",17),Bn(1,1),gt());}function a_(s,t){s&1&&(rt(0,"span",17),Bn(1,2),gt());}function l_(s,t){s&1&&(rt(0,"span",18),Bn(1,3),gt());}function c_(s,t){if(s&1&&(rt(0,"div",14),Be(1,o_,2,0,"span",17)(2,a_,2,0,"span",17)(3,l_,2,0,"span",18),gt()),s&2){let e=vt();Et(),ne(t==="prefer"?1:2),Et(2),ne(e.isIsh()?3:-1);}}function h_(s,t){s&1&&(rt(0,"div",15),Bn(1,4),gt());}function u_(s,t){s&1&&(rt(0,"div",15),Bn(1,5),gt());}function d_(s,t){s&1&&(rt(0,"div",15),Bn(1,6),gt());}function f_(s,t){s&1&&(rt(0,"div",15),Bn(1,7),gt());}function p_(s,t){s&1&&(rt(0,"div",15),Bn(1,8),gt());}function m_(s,t){if(s&1&&le(0,"img",19),s&2){let e=t.$implicit,n=t.$index,i=vt();Gi("--clip-index",n)("--clip-tilt",i.tilt().clips[n]+"deg"),Je("src","/img-pin-"+e+"-v.svg",ql);}}function g_(s,t){let e=2166136261;for(let i=0;i<s.length;i++)e=Math.imul(e^s.charCodeAt(i),16777619)>>>0;let n=[];for(let i=0;i<t;i++)e=Math.imul(e^e>>>15,2246822507)>>>0,e=Math.imul(e^e>>>13,3266489909)>>>0,n.push((e>>>8)/16777215*2-1);return n;}function __(s){if(typeof s!="string")return null;let t=s.toLowerCase().trim(),e=t.startsWith("mostly")||t.endsWith("-ish");return /prevent|unfavo/.test(t)||t==="no"?e?"prevent-ish":"prevent":/prefer|favor/.test(t)||t==="yes"?e?"prefer-ish":"prefer":null;}function y_(s){let t=typeof s=="string"?Number(s):s;return typeof t!="number"||!isFinite(t)?null:t>=90?100:t>=70?75:t>=40?50:t>=10?25:0;}var ma=class s{photo=we(null);arrived=we(!1);favorability=_e(()=>__(this.photo()?.metadata.favorable_future));plausibility=_e(()=>y_(this.photo()?.metadata.plausibility));side=_e(()=>{let t=this.favorability();return t?t.startsWith("prefer")?"prefer":"prevent":null;});clips=_e(()=>{switch(this.favorability()){case"prefer":return["prefer"];case"prefer-ish":return["prefer","prevent"];case"prevent":return["prevent"];case"prevent-ish":return["prevent","prefer"];default:return[];}});isIsh=_e(()=>this.favorability()?.endsWith("-ish")??!1);static MAX_TILT_DEG=3;tilt=_e(()=>{let t=this.photo()?.id??"",[e,...n]=g_(t,3).map(i=>i*s.MAX_TILT_DEG);return{string:e,clips:n};});anchor=$l.required("anchor");rendererService=pe(pn);ngZone=pe(zi);unregisterFrameCb=null;ngOnInit(){this.ngZone.runOutsideAngular(()=>{this.unregisterFrameCb=this.rendererService.addFrameCallback(()=>this.follow());});}ngOnDestroy(){this.unregisterFrameCb?.();}follow(){let t=this.anchor().nativeElement,e=this.photo(),n=e?this.rendererService.getPhotoScreenFrame(e.id):null;if(!n){t.style.visibility="hidden";return;}t.style.visibility="visible",t.style.transform=`translate(${n.x}px, ${n.y}px) rotate(${n.rotation}rad)`,t.style.setProperty("--w",`${n.width}px`);}static ɵfac=function(e){return new(e||s)();};static ɵcmp=an({type:s,selectors:[["app-demo-focus-overlay"]],viewQuery:function(e,n){e&1&&jl(n.anchor,r_,5),e&2&&Ql();},inputs:{photo:[1,"photo"],arrived:[1,"arrived"]},decls:14,vars:12,consts:()=>{let t;t="Gewenst";let e;e="Gevreesd";let n;n="(deels)";let i;i="Verwacht";let r;r="Waarschijnlijk";let o;o="Geloofwaardig";let a;a="Voorstelbaar";let c;return c="Absurd",[["anchor",""],t,e,n,i,r,o,a,c,["aria-hidden","true",1,"demo-focus"],[1,"anchor"],[1,"string-frame"],[1,"string"],[1,"labels"],[1,"favorability"],[1,"plausibility"],["alt","",1,"clip",3,"src","--clip-index","--clip-tilt"],[1,"side"],[1,"ish"],["alt","",1,"clip",3,"src"]];},template:function(e,n){if(e&1&&(rt(0,"div",9)(1,"div",10,0)(3,"div",11),le(4,"div",12),rt(5,"div",13),Be(6,c_,4,2,"div",14)(7,h_,2,0,"div",15)(8,u_,2,0,"div",15)(9,d_,2,0,"div",15)(10,f_,2,0,"div",15)(11,p_,2,0,"div",15),gt()(),Wi(12,m_,1,5,"img",16,Jl),gt()()),e&2){let i,r;Ce("visible",!!n.photo()&&n.arrived())("prefer",n.side()==="prefer")("prevent",n.side()==="prevent"),Et(3),Gi("--string-tilt",n.tilt().string+"deg"),Et(2),Gi("--clip-count",n.clips().length),Et(),ne((i=n.side())?6:-1,i),Et(),ne((r=n.plausibility())===100?7:r===75?8:r===50?9:r===25?10:r===0?11:-1),Et(5),Xi(n.clips());}},styles:[`
...
.demo-focus.visible[_ngcontent-%COMP%]   .clip[_ngcontent-%COMP%] {
  animation: _ngcontent-%COMP%_demo-clip-drop 0.35s cubic-bezier(0.42, 0, 0.25, 1.06) both;
  animation-delay: calc(1s + var(--clip-index, 0) * 0.1s);
}
.demo-focus.visible[_ngcontent-%COMP%]   .favorability[_ngcontent-%COMP%] {
  animation: _ngcontent-%COMP%_demo-fade-in 0.3s ease-out 1s both;
}
...
[_nghost-%COMP%]   .map-rebuild[_ngcontent-%COMP%] {
  position: relative;
}
[_nghost-%COMP%]   .map-rebuild-toggle[_ngcontent-%COMP%] {
  width: 44px;
  height: 44px;
  border: none;
  background: white;
...
[_nghost-%COMP%]   .map-rebuild-toggle[_ngcontent-%COMP%]   .button-icon[_ngcontent-%COMP%] {
  width: 24px;
  height: 24px;
}
[_nghost-%COMP%]   .map-rebuild-toggle[_ngcontent-%COMP%]:hover:not(:disabled) {
  color: #4E02B2;
  background: rgba(78, 2, 178, 0.06);
  transform: scale(1.05);
  box-shadow: 0 3px 12px rgba(78, 2, 178, 0.2);
}
[_nghost-%COMP%]   .map-rebuild-toggle.busy[_ngcontent-%COMP%] {
  cursor: progress;
  color: #4E02B2;
}
[_nghost-%COMP%]   .map-rebuild-toggle.busy[_ngcontent-%COMP%]   .button-icon[_ngcontent-%COMP%] {
  animation: _ngcontent-%COMP%_map-rebuild-spin 1.2s linear infinite;
}
[_nghost-%COMP%]   .map-rebuild-status[_ngcontent-%COMP%] {
  position: absolute;
  top: 50%;
  right: 52px;
  transform: translateY(-50%);
...
[_nghost-%COMP%]   .map-rebuild-status.done[_ngcontent-%COMP%] {
  color: #2E7D32;
}
[_nghost-%COMP%]   .map-rebuild-status.empty[_ngcontent-%COMP%] {
  color: #B26A00;
}
[_nghost-%COMP%]   .map-rebuild-status.failed[_ngcontent-%COMP%] {
  color: #C62828;
}
@keyframes _ngcontent-%COMP%_map-rebuild-spin {
  to {
    transform: rotate(360deg);
  }
}
...
}`]});};export{pu as ShowcaseWsComponent};/**i18n:8dff8178f621bcc69192725557201a809317b399ed00a24037a7b59a2f24ea18*/